  ...
  columns = list(
    V1 = colDef(footer = "Total", style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        R1 <- if (!is.na(R1)) R1 else ""
        tagList(
          div(style = list(fontSize = 20, fontWeight = 500, color = '#0F2040', fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#800000'), R1),
        )
      },
      align = "center"
...
reactable(
  ...
  columns = list(
    Translation = colDef(style= list(background = '#f7f7f7'),
      cell = function(value, index) {
        ...
        Sentences <- if (!is.na(Sentences)) Sentences else ""
        tagList(
          div(style = list(fontSize = 20, fontWeight = 600, fontFamily = 'Open Sans', color = '#303030'), Sentences),
          div(style = list(fontSize = 11, fontWeight = 300, color = '#303030'), value)
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, paginationType = "simple", striped = TRUE, height = 530,
  ...
  columns = list(
    ...
    Sentence = colDef(minWidth = 70, style= list(background = '#dee7e7', color = '#0F2040'),
      cell = function(value, index) {
        ...
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 13.5, color = '#0F2040', fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 9, color = '#0F2040'), Translation),
        )
      },
      align = "left"
    ),
  ...
  columns = list(
    Words = colDef(
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 52, fontWeight = 600, color = '#303030'), value),
  ...
  columns = list(
    Words = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 52, fontWeight = 600, color = '#0F2040'), value),
  ...
  columns = list(
    Words = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 55, fontWeight = 600, color = '#0F2040'), value),
          # div(style = list(fontSize = 9), Reading),
          # div(style = list(fontSize = 8), Meaning),
        )
      },
