...
cmpvrbs <- read_csv("jpdb/VRBCOMPD-WRDS.csv")
...
nadj2.a <- nadj2  %>% rename(Sentences = S1)
...
nounw.a <- nounw %>% slice(1:200) %>% rename(Sentences = S1)
...
###### **1.** `pikapika・kasakasa・gatgata・gorogoro`
###### **2.** `chanto・unto`
###### **3.** `satto・jitto・atto`
###### **4.** `yukkuri・shikkari・uttori・hakkiri`
###### **5.** `nonbiri・bonyari・hinyari`
...
<!-- learn.comm <- learn %>% slice(162:173) -->
...
### Communication Honorifics {.tabset}
...
### PT2.0: Phrasal Noun {.tabset}

<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020;">**Phrasal Noun** are modified nouns. Modifiers precedes the noun it modifies.</p>
...
### PT3.0: Phrasal Verb {.tabset}

<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020;">**Phrasal Verb** are modified verbs. A more specific nuance added to its original meaning.</p>
...
##### Auxiliaries
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">**Auxiliaries** are attached to a verb to create a more specific meaning.</p>

<p style="font-size:13px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; font-weight: bold">**① Verb + Auxiliary: Structure**</p>

###### **⚭　Vneg-stem・Vnoun-stem・Vru・Vcmd-stem・Vte・Vta + Auxiliary**
...
reactable(
  ...
  columns = list(
      Sentence = colDef(
      cell = function(value, index) {
        Phrasal.Verb <- cmpvrbs$Phrasal.Verb[index]
        Phrasal.Verb <- if (!is.na(Phrasal.Verb)) Phrasal.Verb else ""
        Translation <- cmpvrbs$Translation[index]
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 24, fontWeight = 600), Phrasal.Verb),
          div(style = list(fontSize = 16, fontWeight = 500), value),
          div(style = list(fontSize = 8, fontWeight = 400, color = '#787878'), Translation)
        )
      },
    ...
    Reading = colDef(show = FALSE),
    Meaning = colDef(show = FALSE),
    Phrasal.Verb = colDef(show = FALSE),
    Translation = colDef(show = FALSE)
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
  ...
  columns = list(
    Words = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 27, fontWeight = 600, color = '#202020', fontFamily = 'Yomogi'), value),
          div(style = list(fontSize = 12, fontWeight = 600, color = '#202020', fontFamily = 'Klee One'), Meaning),
          div(style = list(fontSize = 11, fontWeight = 400, color = '#202020', fontFamily = 'Klee One'), "Level: ", Level),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 20, fontWeight = 600, color = '#202020', fontFamily = 'Yomogi'), Sentence),
        )
      },
      align = "center"
    ),
...
learn.evlrcg <- learn %>% slice(211:211)
...
learn.evlrcl <- learn %>% slice(212:212)
  ...
  columns = list(
      Expression = colDef(
       cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 26, fontWeight = 800, fontFamily = 'Yomogi'), value),
          div(style = list(fontSize = 15, fontWeight = 500), Expn),
          div(style = list(fontSize = 11, fontWeight = 300), Trans),
          div("•"),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Yomogi'), Convo1),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T1),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Yomogi'), Convo2),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T2),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Yomogi'), Convo3),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T3),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Yomogi'), Convo4),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T4),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Yomogi'), Convo5),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T5),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Yomogi'), Convo6),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T6),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Yomogi'), Convo7),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T7),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Yomogi'), Convo8),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T8),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Yomogi'), Convo9),
