...
##### Compounds
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">A **Compound Verb** is a verb that consists of two verbs creating a specific meaning.</p>
...
###### **⚭　Verb**
    ...
    ・彼はボーナスを当て込んでいた
    ・彼は実験に基づいて学説を打ち立てた
    ・彼は５０００万円を複数の口座に分けて預け入れていた

<!-- <h> -->

    ・He was counting on the bonus
    ・He formulated his theories based on experiments
    ・He deposited 50 million yen in several separate accounts
