...
#### Relative Information {.tabset}

------------------------------------------------------------------------

### PT3.0: Phrasal Verb {.tabset}

<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020;">**Phrasal Verb** are modified verbs Modifiers precedes the verb it modifies.</p>
...
<p style="font-size:13px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; font-weight: bold">**①  Compound Verb: Forms**</p>
...
reactable(
  ...
  columns = list(
      Sentence = colDef(
      cell = function(value, index) {
        Compound.Verb <- cmpvrbs$Compound.Verb[index]
        Compound.Verb <- if (!is.na(Compound.Verb)) Compound.Verb else ""
        Translation <- cmpvrbs$Translation[index]
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 24, fontWeight = 600), Compound.Verb),
          div(style = list(fontSize = 16, fontWeight = 500), value),
          div(style = list(fontSize = 8, fontWeight = 400, color = '#787878'), Translation)
        )
      },
    ...
    Reading = colDef(show = FALSE),
    Meaning = colDef(show = FALSE),
    Compound.Verb = colDef(show = FALSE),
    Translation = colDef(show = FALSE)
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
