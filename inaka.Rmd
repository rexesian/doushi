...
nadj2.a <- nadj2  %>% slice(1:125) %>% rename(Sentences = S1)
...
nadj1.a <- nadj1 %>% slice(1:250) %>% rename(Sentences = S1)
...
nounw.a <- nounw %>% slice(1:250) %>% rename(Sentences = S1)
    ...
    Words = colDef(
      cell = function(value, index) {
        ...
        tagList(
          # div(style = list(fontSize = 24, fontWeight = 600, color = '#404040'), value),
          # div(style = list(fontSize = 11, color = '#404040'), Reading),
          div(style = list(fontSize = 10, fontWeight = 600, color = '#404040'), Meaning)
        )
      },
      align = "center"
    ),
