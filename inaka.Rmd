...
reactable(
  scknj5w.d,
  columns = list(
    W1 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, background = '#ededdf')),
    W2 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, background = '#ededdf')),
    W3 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, background = '#ededdf'))
  ),
  defaultPageSize = 5,
  theme = reactableTheme(
    # Vertically center cells
...
reactable(
  scknja.xf,
  columns = list(
    W1 = colDef(footer = "Total", style= list(background = '#ededdf'),
      cell = function(value, index) {
    ...
    W2 = colDef(style= list(background = '#ededdf'),
      cell = function(value, index) {
    ...
    W3 = colDef(style= list(background = '#ededdf'),
      cell = function(value, index) {
    ...
    W4 = colDef(style= list(background = '#ededdf'),
      cell = function(value, index) {
    ...
    W5 = colDef(style= list(background = '#ededdf'),
      cell = function(value, index) {
    ...
    W6 = colDef(style= list(background = '#ededdf'),
      cell = function(value, index) {
  ...
  columns = list(
    W1 = colDef(footer = "Total", style= list(background = '#ededdf'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 8, fontWeight = 400, color = '#002070'), M1),
        )
      },
      align = "center"
    ),
    W2 = colDef(style= list(background = '#ededdf'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 8, fontWeight = 400, color = '#002070'), M2),
        )
      },
      align = "center"
    ),
    W3 = colDef(style= list(background = '#ededdf'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 8, fontWeight = 400, color = '#002070'), M3),
        )
      },
      align = "center"
    ),
    W4 = colDef(style= list(background = '#ededdf'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 8, fontWeight = 400, color = '#002070'), M4),
        )
      },
      align = "center"
    ),
    W5 = colDef(style= list(background = '#ededdf'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 8, fontWeight = 400, color = '#002070'), M5),
        )
      },
      align = "center"
    ),
    W6 = colDef(style= list(background = '#ededdf'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 8, fontWeight = 400, color = '#002070'), M6),
        )
      },
      align = "center"
    ),
