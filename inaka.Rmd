  ...
  columns = list(
    Expression = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 34, fontWeight = 600, color = '#6495BF', fontFamily = 'Georgia'), value),
          # div(style = list(fontSize = 2), "."),
          # div(style = list(fontSize = 2), "."),
          # div(style = list(fontSize = 2), "."),
          # div(style = list(fontSize = 2), "."),
...
reactable(
  phrsaux,
  columns = list(
    Expression = colDef(align = "left", style = list(fontSize = 16, fontWeight = 500, fontFamily = 'Noto Sans JP', color = '#555555')),
