...
reactable(
  ...
  columns = list(
    Sentences = colDef(style= list(background = '#f7f7f7'),
      cell = function(value, index) {
        Translation <- knjsnt.la$Translation[index]
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
...
reactable(
  ...
  columns = list(
    Sentences = colDef(style= list(background = '#f7f7f7'),
      cell = function(value, index) {
        Translation <- scrptexps.a$Translation[index]
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 20, fontWeight = 600, color = '#303030', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 11, fontWeight = 300, color = '#303030'), Translation)
  ...
  columns = list(
    ...
    W5 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value),
          div(style = list(fontSize = 8, fontWeight = 600, color = '#266c6c'), M5),
        )
      },
      align = "center"
    ),
    W6 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value),
          div(style = list(fontSize = 9, fontWeight = 600, color = '#266c6c'), M6),
        )
      },
      align = "center"
    ),
...
reactable(
  ...
  showPageInfo = FALSE, outlined = TRUE, borderless = TRUE, bordered = TRUE, searchable = TRUE, paginationType = "numbers", striped = TRUE, height = 530,
