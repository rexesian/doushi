...
<!--         tagList( -->
<!--           div(class = "lesserh", style = list(fontSize = 30, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), Words), -->
<!--           div(class = "lesserh", style = list(fontSize = 16, fontWeight = 600, color = '#800000'), Reading), -->
<!--           # div(style = list(fontSize = 10, fontWeight = 500, color = '#404040'), value) -->
<!--         ) -->
<!--       }, -->
<!--       align = "center" -->
...
rvwadjna <- rvwadjna[sample(1:nrow(rvwadjna)),]
...
reactable(
  ...
  columns = list(
    Words = colDef(
      cell = function(value, index) {
        Reading <- rvwadjna$Reading[index]
        Reading <- if (!is.na(Reading)) Reading else ""
        Meaning <- rvwadjna$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        Hint.1 <- rvwadjna$Hint.1[index]
        Hint.1 <- if (!is.na(Hint.1)) Hint.1 else ""
        Hint.2 <- rvwadjna$Hint.2[index]
        Hint.2 <- if (!is.na(Hint.2)) Hint.2 else ""
        tagList(
          div(style = list(fontSize = 28, fontWeight = 600, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 10, color = '#008000'), Reading),
          div(style = list(fontSize = 10, color = '#800000'), Meaning),
          div(style = list(fontSize = 12), Hint.1),
          div(style = list(fontSize = 12), Hint.2)
        )
      },
      align = "center"
    ),
    Reading = colDef(show = FALSE),
    Meaning = colDef(show = FALSE),
    Hint.1 = colDef(show = FALSE),
    Hint.2 = colDef(show = FALSE)
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", fontSize = "11px", height = 250),
...
reactable(
  rvwadjna,
  columns = list(
    Words = colDef(align = "center", style = list(fontSize = 28, fontWeight = 600, fontFamily = 'Open Sans')),
    Reading = colDef(show = FALSE),
    Meaning = colDef(show = FALSE),
    Hint.1 = colDef(show = FALSE),
    Hint.2 = colDef(show = FALSE)
  ...
  columns = list(
    Verbs = colDef(
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(span(style = list(fontSize = 24, fontWeight = 600, fontFamily = 'Open Sans'), value), span(style = list(fontSize = 13, fontWeight = 600, color = '#007000'), Reading), span(style = list(fontSize = 11, fontWeight = 600, color = '#800000'), Meaning))
        )
      },
      align = "left"
    ),
  ...
  columns = list(
    Verbs = colDef(
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(span(style = list(fontSize = 24, fontWeight = 600, fontFamily = 'Open Sans'), value), span(style = list(fontSize = 13, fontWeight = 600, color = '#007000'), Reading))
        )
      },
      align = "left"
    ),
  ...
  columns = list(
    Verbs = colDef(
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(span(style = list(fontSize = 24, fontWeight = 600, fontFamily = 'Open Sans'), value), span(style = list(fontSize = 11, fontWeight = 600, color = '#800000'), Meaning))
        )
      },
      align = "center"
    ),
