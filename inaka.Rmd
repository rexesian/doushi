...
spclkjn.a <- spclkjn %>% select(Words, Reading, Meaning) %>% slice(1:42)
...
reactable(
  spclkjn.a,
  columns = list(
    Words = colDef(minWidth = 30,align = "left", style = list(fontSize = 13.5, fontFamily = 'Open Sans')),
    Reading = colDef(minWidth = 30,align = "left", style = list(fontSize = 11, fontFamily = 'Open Sans')),
    Meaning = colDef(minWidth = 90,align = "left", style = list(fontSize = 11, fontFamily = 'Open Sans'))
  ),
  defaultPageSize = 7,
  theme = reactableTheme(
    # Vertically center cells
...
spclkjn.a <- spclkjn %>% select(Words) %>% slice(1:42)
spclkjn.a <- spclkjn.a %>% na.omit(spclkjn.a)
spclkjn.a <- spclkjn.a[sample(1:nrow(spclkjn.a)),]
...
adjirmbr.a <- adjirmbr  %>% slice(1:160) %>% select(Words, Expression)
