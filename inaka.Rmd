...
reactable(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE, height = 478,
    ...
    Words = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 15, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), value),
        )
      },
      align = "left"
    ),
    Reading = colDef(align = "left", style = list(fontSize = 13, fontWeight = 400, color = '#404040', fontFamily = 'Open Sans')),
...
reactable(
  rdngprp,
  columns = list(
    Script = colDef(minWidth = 350, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans')),
    Translation = colDef(show = FALSE)
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", height = 300, resizable = TRUE, striped = FALSE,
  ...
  columns = list(
    Notes = colDef(
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 15, fontWeight = 400, color = '#404040', fontFamily = 'Open Sans'), value),
        )
      },
      align = "left"
    ),
