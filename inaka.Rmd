...
<!-- audiolist.a <- audiolist %>% rename(Rnd.Listen = Expression) -->
<!-- audiolist.a <- audiolist.a[sample(1:nrow(audiolist.a)),] -->

<!-- reactable( -->
<!--   audiolist.a, -->
<!--   columns = list( -->
<!--     Rnd.Listen = colDef(minWidth = 500,align = "left", html = TRUE) -->
<!--   ), -->
<!--   defaultPageSize = 1, -->
<!--   theme = reactableTheme( -->
<!--     # Vertically center cells -->
