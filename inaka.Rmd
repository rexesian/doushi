...
nadj2.c <- nadj2.z[sample(1:nrow(nadj2.c)),]
...
reactable(
  ...
  onClick = "expand",
  columns = list(
    Expression = colDef(minWidth = 40, align = "left", style = list(fontSize = 15, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans')),
    Meaning = colDef(align = "left"),
    Usage = colDef(align = "left"),
    Category = colDef(minWidth = 40, align = "left"),
