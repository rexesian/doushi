...
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">Version 🆅.3.2</p>
...
learn.mental <- learn %>% slice(295:296)
...
### Cognitive Ability {.tabset}

<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">**Cognitive Skills:**</p>

```{r, echo=FALSE, message=FALSE}

learn.cgntv <- learn %>% slice(326:326)
    ...
    Words = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 17, fontWeight = 600, fontFamily = 'Open Sans', color = '#10111F'), Related.Words)
        )
      },
      align = "left"
    ),
