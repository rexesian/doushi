...
reactable(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE, height = 5,
  ...
  columns = list(
    W1 = colDef(
      cell = function(value, index) {
        ...
        R1 <- if (!is.na(R1)) R1 else ""
        tagList(
          div(style = list(fontSize = 22, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
...
reactable(
  ...
  columns = list(
    ...
    W5 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 22, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#008000'), M5),
        )
      },
      align = "center"
    ),
    W6 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 22, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#008000'), M6),
        )
      },
      align = "center"
    ),
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE, wrap = FALSE,
