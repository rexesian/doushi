...
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">**Attitude and Way of doing:**</p>
...
reactable(
  scrptrdgn,
  columns = list(
    Excerpts = colDef(minWidth = 350, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Helvetica Neue')),
    Translation = colDef(show = FALSE)
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", height = 800, resizable = TRUE,
