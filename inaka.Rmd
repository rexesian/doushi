...
spclkjn.z <- spclkjn %>% select(Words, Reading, Meaning) %>% slice(43:70)
...
spclkjn.z <- spclkjn %>% select(Words) %>% slice(43:70)
spclkjn.x <- spclkjn.x[sample(1:nrow(spclkjn.x)),]
spclkjn.z <- spclkjn.z[sample(1:nrow(spclkjn.z)),]
spclkjn.a <- bind_rows(spclkjn.z, spclkjn.x)
# spclkjn.a <- spclkjn %>% select(Words, Reading, Meaning) %>% slice(1:56)
...
spclkjnsr.x <- spclkjnsr %>% select(Words, Reading, Meaning)
# spclkjnsr.z <- spclkjn %>% select(Words, Reading, Meaning) %>% slice(43:70)
spclkjnsr.x <- spclkjnsr.x[sample(1:nrow(spclkjnsr.x)),]
# spclkjn.z <- spclkjn.z[sample(1:nrow(spclkjn.z)),]
# spclkjn.a <- bind_rows(spclkjn.z, spclkjn.x)
# spclkjn.a <- spclkjn %>% select(Words, Reading, Meaning) %>% slice(1:56)
spclkjnsr.x <- spclkjnsr.x %>% na.omit(spclkjnsr.x)
# spclkjn.a <- spclkjn.a[sample(1:nrow(spclkjn.a)),]
...
reactable(
  ...
  columns = list(
    Words = colDef(
      cell = function(value, index) {
        Reading <- spclkjnsr.x$Reading[index]
        Reading <- if (!is.na(Reading)) Reading else ""
        Meaning <- spclkjnsr.x$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 40, fontWeight = 600, fontFamily = 'Open Sans'), value),
          # div(style = list(fontSize = 10, color = '#008000'), Reading),
