...
rdngprp <- read_csv("jpdb/RDNGPRP-SCRPT.csv")
...
kanawrds.f <- data.frame(kanawrds.a, kanawrds.b, kanawrds.c, kanawrds.d, kanawrds.e)
...
reactable(
  ...
  columns = list(
    Words = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 15, fontWeight = 400, fontFamily = 'Open Sans', color = '#0F2040'), value, "。",  Words.1, "。",  Words.2, "。",  Words.3, "。",  Words.4, "。")
        )
      },
      align = "left"
    ),    
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE, height = 510,
...
# scknja.z <- scknja.z[sample(1:nrow(scknja.z)),]
...
reactable(
  ...
  columns = list(
    Kanji = colDef(
      # Show species under character names
      cell = function(value, index) {
        Meaning <- scknja.x$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        NR <- scknja.x$NR[index]
        NR <- if (!is.na(NR)) NR else ""
        KR <- scknja.x$KR[index]
        KR <- if (!is.na(KR)) KR else ""
        tagList(
          div(style = list(fontSize = 30, fontWeight = 600, fontFamily = 'Open Sans'), value),
          # div(style = list(fontSize = 9, color = '#008000'), NR),
    ...
    W1 = colDef(
      cell = function(value, index) {
        M1 <- scknja.x$M1[index]
        M1 <- if (!is.na(M1)) M1 else ""
        R1 <- scknja.x$R1[index]
        R1 <- if (!is.na(R1)) R1 else ""
        tagList(
    ...
    W2 = colDef(
      cell = function(value, index) {
        M2 <- scknja.x$M2[index]
        M2 <- if (!is.na(M2)) M2 else ""
        R2 <- scknja.x$R2[index]
        R2 <- if (!is.na(M2)) R2 else ""
        tagList(
          div(style = list(fontSize = 19, fontWeight = 600, fontFamily = 'Open Sans'), value),
    ...
    W3 = colDef(
      cell = function(value, index) {
        M3 <- scknja.x$M3[index]
        M3 <- if (!is.na(M3)) M3 else ""
        R3 <- scknja.x$R3[index]
        R3 <- if (!is.na(R3)) R3 else ""
        tagList(
          div(style = list(fontSize = 19, fontWeight = 600, fontFamily = 'Open Sans'), value),
  ...
  columns = list(
    ...
    W1 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 19, fontWeight = 600, fontFamily = 'Open Sans'), value),
          # div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), R1),
    ...
    W2 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 19, fontWeight = 600, fontFamily = 'Open Sans'), value),
          # div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), R2),
    ...
    W3 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 19, fontWeight = 600, fontFamily = 'Open Sans'), value),
          # div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), R3),
  ...
  columns = list(
    Words = colDef(
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 26, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), value),
    ...
    Sentences = colDef(
      ...
      cell = function(value, index) {
        ...
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 18, fontWeight = 500, color = '#404040', fontFamily = 'Open Sans'), value),
...
# rdngprp <- rdngprp  %>% slice(1:1)

reactable(
  rdngprp,
  columns = list(
    Script = colDef(minWidth = 100, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Helvetica Neue')),
    Translation = colDef(html = TRUE, style = list(color = '#0F2040'))
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", height = 320, resizable = TRUE, striped = TRUE,
