...
nadj2.a <- nadj2  %>% slice(1:160) %>% rename(Sentences = S1, Translation = T1)
  ...
  columns = list(
      Expression = colDef(
       cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 26, fontWeight = 800, fontFamily = 'Zen Maru Gothic'), value),
          div(style = list(fontSize = 15, fontWeight = 500), Expn),
          div(style = list(fontSize = 11, fontWeight = 300), Trans),
          div("•"),
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Zen Maru Gothic'), Convo1),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T1),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Zen Maru Gothic'), Convo2),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T2),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Zen Maru Gothic'), Convo3),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T3),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Zen Maru Gothic'), Convo4),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T4),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Zen Maru Gothic'), Convo5),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T5),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Zen Maru Gothic'), Convo6),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T6),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Zen Maru Gothic'), Convo7),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T7),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Zen Maru Gothic'), Convo8),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#787878'), T8),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Zen Maru Gothic'), Convo9),
...
<!-- lverbs.a <- lverbs %>% slice(1:100) -->
<!-- lverbs.a <- lverbs.a %>% rename(Sentences = S1) -->
...
<!--     Verbs = colDef( -->
<!--       cell = function(value, index) { -->
<!--         Meaning <- lverbs.a$Meaning[index] -->
<!--         Meaning <- if (!is.na(Meaning)) Meaning else "" -->
<!--         Reading <- lverbs.a$Reading[index] -->
<!--         Reading <- if (!is.na(Reading)) Reading else "" -->
<!--         Words <- lverbs.a$Words[index] -->
<!--         Words <- if (!is.na(Words)) Words else "" -->
<!--         Type <- lverbs.a$Type[index] -->
<!--         Type <- if (!is.na(Type)) Type else "" -->
<!--         Sentences <- lverbs.a$Sentences[index] -->
<!--         Sentences <- if (!is.na(Sentences)) Sentences else "" -->
<!--         T1 <- lverbs.a$T1[index] -->
<!--         T1 <- if (!is.na(T1)) T1 else "" -->
<!--         tagList( -->
...
<!-- lverbs.b <- lverbs %>% slice(1:100) -->
<!-- lverbs.b <- lverbs.b %>% rename(Sentences = S1) -->
<!-- lverbs.b <- lverbs.b[sample(1:nrow(lverbs.b)),] -->
...
<!--     Verbs = colDef( -->
<!--       cell = function(value, index) { -->
<!--         Meaning <- lverbs.b$Meaning[index] -->
<!--         Meaning <- if (!is.na(Meaning)) Meaning else "" -->
<!--         Reading <- lverbs.b$Reading[index] -->
<!--         Reading <- if (!is.na(Reading)) Reading else "" -->
<!--         Words <- lverbs.b$Words[index] -->
<!--         Words <- if (!is.na(Words)) Words else "" -->
<!--         Type <- lverbs.b$Type[index] -->
<!--         Type <- if (!is.na(Type)) Type else "" -->
<!--         Sentences <- lverbs.b$Sentences[index] -->
<!--         Sentences <- if (!is.na(Sentences)) Sentences else "" -->
<!--         T1 <- lverbs.b$T1[index] -->
<!--         T1 <- if (!is.na(T1)) T1 else "" -->
<!--         tagList( -->
<!--           # div(style = list(fontSize = 28, fontWeight = 500), value), -->
<!--           # div(style = list(fontSize = 12), Reading), -->
...
<!-- lverbs.c <- lverbs %>% slice(1:100) -->
<!-- lverbs.c <- lverbs.c %>% rename(Sentences = S1) -->
...
<!--     Verbs = colDef( -->
<!--       cell = function(value, index) { -->
<!--         Meaning <- lverbs.c$Meaning[index] -->
<!--         Meaning <- if (!is.na(Meaning)) Meaning else "" -->
<!--         Reading <- lverbs.c$Reading[index] -->
<!--         Reading <- if (!is.na(Reading)) Reading else "" -->
<!--         Words <- lverbs.c$Words[index] -->
<!--         Words <- if (!is.na(Words)) Words else "" -->
<!--         Type <- lverbs.c$Type[index] -->
<!--         Type <- if (!is.na(Type)) Type else "" -->
<!--         Sentences <- lverbs.c$Sentences[index] -->
<!--         Sentences <- if (!is.na(Sentences)) Sentences else "" -->
<!--         T1 <- lverbs.c$T1[index] -->
<!--         T1 <- if (!is.na(T1)) T1 else "" -->
<!--         tagList( -->
<!--           # div(style = list(fontSize = 28, fontWeight = 500), value), -->
<!--           # div(style = list(fontSize = 12), Reading), -->
<!--           # div(style = list(fontSize = 9.2, fontWeight = 500), Meaning), -->
<!--           # div(style = list(fontSize = 9), Type), -->
<!--           # div(style = list(fontSize = 14.5), Sentences), -->
