  ...
  columns = list(
    Expression = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 36, fontWeight = 800, color = '#0F2040', fontFamily = 'Open Sans'), value),
        )
      },
      align = "center"
    ),
...
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">**Mastery:** Be able to master different elements of the language. Act and React in any given situation. 
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">Deep knowledge and understanding on the topic of choice and the describe or discuss it using the language.</p>
...
reactable(
  dlyrdg,
  columns = list(
    Script = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7')),
    Translation = colDef(show = FALSE)
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  ...
  columns = list(
    ...
    Reading = colDef(align = "left", style = list(fontSize = 13, fontWeight = 400, color = '#0F2040', fontFamily = 'Open Sans')),
    Meaning = colDef(minWidth = 250, align = "left", style = list(color = '#0F2040')),
    Reading = colDef(show = FALSE)
...
reactable(
  ...
  columns = list(
    ...
    Translation = colDef(align = "left", style = list(color = '#0F2040'))
  ),
  defaultPageSize = 8,
  theme = reactableTheme(
    # Vertically center cells
...
reactable(
  rdngchp,
  columns = list(
    Scripts = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7')),
    Translation = colDef(show = FALSE)
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
  ...
  columns = list(
    Words = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(span(style = list(fontSize = 24, fontWeight = 600, fontFamily = 'Open Sans', color = '#11111F'), value), span(style = list(fontSize = 11, fontWeight = 600, color = '#00906F'), Reading, " "), span(style = list(fontSize = 11, fontWeight = 600, color = '#800000'), Meaning)),
          div(style = list(fontSize = 15, fontWeight = 300, fontFamily = 'Helvetica Neue', color = '#10111F'), Related.Words)
        )
      },
      align = "left"
    ),
