...
scrptrvw.a <- scrptrvw.a %>% rename(Kanji = value)
scrptrvw.a <- na.omit(scrptrvw.a) %>% select(Kanji)
scrptrvw.a <- scrptrvw.a[sample(1:nrow(scrptrvw.a)),]

reactable(
  scrptrvw.a,
  columns = list(
    Kanji = colDef(align = "center", style = list(fontSize = 28, fontWeight = 600, fontFamily = 'Open Sans'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    # Vertically center cells
...
exvded.a <- exvded %>% rename(Rnd.Educational = Expression)
