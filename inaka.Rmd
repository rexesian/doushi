...
spclkjn.a <- spclkjn %>% select(Words)
...
reactable(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", height = 350, resizable = TRUE, striped = FALSE,
