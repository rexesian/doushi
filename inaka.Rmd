...
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">Version 🆅.3.4</p>
...
reactable(
  ...
  theme = reactableTheme(
    # Vertically center cells
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 238),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
...
reactable(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "simple", striped = TRUE, height = 353,
...
reactable(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE, height = 520,
...
reactable(
  scknj5w.d,
  columns = list(
    W1 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, background = '#fffbea')),
    W2 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, background = '#fffbea')),
    W3 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, background = '#fffbea'))
  ),
  defaultPageSize = 5,
  theme = reactableTheme(
    # Vertically center cells
...
scrptwrdx.x <- scrptwrdx %>% select(Word, Reading, Meaning)
...
scrptwrdx <- scrptwrdx[sample(1:nrow(scrptwrdx)),]

scrptwrdx.a <- scrptwrdx %>% select(Word) %>% rename(W1 = Word) %>% slice(1:323)
scrptwrdx.b <- scrptwrdx %>% select(Word) %>% rename(W2 = Word) %>% slice(324:646)
scrptwrdx.c <- scrptwrdx %>% select(Word) %>% rename(W3 = Word) %>% slice(647:969)

scrptwrdx.a <- scrptwrdx.a[sample(1:nrow(scrptwrdx.a)),]
scrptwrdx.b <- scrptwrdx.b[sample(1:nrow(scrptwrdx.b)),]
scrptwrdx.c <- scrptwrdx.c[sample(1:nrow(scrptwrdx.c)),]

scrptwrdx.d <- data.frame(scrptwrdx.a, scrptwrdx.b, scrptwrdx.c)
...
reactable(
  scknja.xf,
  columns = list(
    W1 = colDef(footer = "Total", style= list(background = '#fffbea'),
      cell = function(value, index) {
    ...
    W2 = colDef(style= list(background = '#fffbea'),
      cell = function(value, index) {
    ...
    W3 = colDef(style= list(background = '#fffbea'),
      cell = function(value, index) {
    ...
    W4 = colDef(style= list(background = '#fffbea'),
      cell = function(value, index) {
    ...
    W5 = colDef(style= list(background = '#fffbea'),
      cell = function(value, index) {
    ...
    W6 = colDef(style= list(background = '#fffbea'),
      cell = function(value, index) {
  ...
  columns = list(
    Expression = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 36, fontWeight = 800, color = '#2F3F3F', fontFamily = 'Open Sans'), value),
        )
      },
      align = "center"
    ),
...
reactable(
  phrsaux,
  columns = list(
    Expression = colDef(align = "left", style = list(fontSize = 17, fontWeight = 600, fontFamily = 'Open Sans', color = '#555555')),
...
reactable(
  rdngchp,
  columns = list(
    Scripts = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Helvetica Neue')),
    Translation = colDef(html = TRUE, style = list(color = '#0F2040'))
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = FALSE, sortable = FALSE, paginationType = "numbers", height = 320, resizable = TRUE, striped = FALSE,
...
reactable(
  ...
  columns = list(
    Script = colDef(
      minWidth = 280,
      cell = function(value, index) {
        Translation <- rdngprp$Translation[index]
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 19, fontWeight = 200, color = '#0F2040', fontFamily = 'Helvetica Neue'), value),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "simple", height = 600, striped = TRUE, 
