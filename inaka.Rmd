...
adjirmbr.a <- adjirmbr  %>% slice(1:50) %>% select(Words, Expression)
...
reactable(
  ...
  columns = list(
    V1 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 9, color = '#787878'), R1),
          div(style = list(fontSize = 9, color = '#787878'), M1)
        )
      },
      align = "center"
    ),
    V2 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, color = '#787878'), R2),
          div(style = list(fontSize = 9, color = '#787878'), M2)
        )
      },
      align = "center"
    ),    
    V3 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 11, color = '#787878'), R3),
          div(style = list(fontSize = 10, color = '#787878'), M3)
        )
      },
      align = "center"
    ), 
    V4 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, color = '#787878'), R4),
          div(style = list(fontSize = 9, color = '#787878'), M4)
        )
      },
      align = "center"
    ),
  ...
  defaultPageSize = 5,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 110, fontSize = "11px"),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
