...
scknja.z <- bind_rows(scknj5.a, scknj4.a)
scknja.z <- bind_rows(scknja.z, scknj3.a)
scknja.z <- bind_rows(scknja.z, scknj2.a)
scknja.z <- bind_rows(scknja.z, scknj1.a)
...
reactable(
  ...
  columns = list(
    Kanji = colDef(
      # Show species under character names
      cell = function(value, index) {
        Meaning <- scknja.z$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        NR <- scknja.z$NR[index]
        NR <- if (!is.na(NR)) NR else ""
        KR <- scknja.z$KR[index]
        KR <- if (!is.na(KR)) KR else ""
        tagList(
          div(style = list(fontSize = 30, fontWeight = 600, fontFamily = 'Open Sans'), value),
          # div(style = list(fontSize = 9, color = '#008000'), NR),
    ...
    W1 = colDef(
      cell = function(value, index) {
        M1 <- scknja.z$M1[index]
        M1 <- if (!is.na(M1)) M1 else ""
        R1 <- scknja.z$R1[index]
        R1 <- if (!is.na(R1)) R1 else ""
        tagList(
          div(style = list(fontSize = 19, fontWeight = 600, fontFamily = 'Open Sans'), value),
    ...
    W2 = colDef(
      cell = function(value, index) {
        M2 <- scknja.z$M2[index]
        M2 <- if (!is.na(M2)) M2 else ""
        R2 <- scknja.z$R2[index]
        R2 <- if (!is.na(M2)) R2 else ""
        tagList(
          div(style = list(fontSize = 19, fontWeight = 600, fontFamily = 'Open Sans'), value),
    ...
    W3 = colDef(
      cell = function(value, index) {
        M3 <- scknja.z$M3[index]
        M3 <- if (!is.na(M3)) M3 else ""
        R3 <- scknja.z$R3[index]
        R3 <- if (!is.na(R3)) R3 else ""
        tagList(
          div(style = list(fontSize = 19, fontWeight = 600, fontFamily = 'Open Sans'), value),
