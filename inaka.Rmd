...
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">Version 🆅.3.3</p>
...
learn.atten <- learn %>% slice(304:307)
...
learn.cognitive <- learn %>% slice(323:323)
...
learn.cognitive <- learn %>% slice(311:320)
...
learn.architbl <- architbl %>% slice(1:7)

reactable(
  learn.architbl,
  columns = list(
    Item = colDef(minWidth = 30, align = "left"),
...
learn.architbl <- architbl %>% slice(8:17)
...
spclkjn.z <- spclkjn %>% select(Words, Reading, Meaning) %>% slice(43:56)
...
spclkjn.z <- spclkjn %>% select(Words) %>% slice(43:56)
spclkjn.x <- spclkjn.x[sample(1:nrow(spclkjn.x)),]
spclkjn.z <- spclkjn.z[sample(1:nrow(spclkjn.z)),]
spclkjn.a <- bind_rows(spclkjn.z, spclkjn.x)
# spclkjn.a <- spclkjn %>% select(Words, Reading, Meaning) %>% slice(1:56)
...
reactable(
  verbtbl.e,
  columns = list(
    V1 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans')),
    V2 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans')),
    V3 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans')),
    V4 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans'))
  ),
  defaultPageSize = 5,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 95, fontSize = "11px"),
...
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">**Listening and Hearing:** Be able to listen and hear the words clearly is the way to proficiency.</p>
...
風呂敷　![](audio/kikitori_na/02 Track 2.mp3)   
出前は　![](audio/kikitori_na/07 Track 7.mp3)   
小さな　![](audio/kikitori_na/09 Track 9.mp3)    
犬です　![](audio/kikitori_na/11 Track 11.mp3)    
もしも　![](audio/kikitori_nb/01 トラック 1.mp3)     
旗のデ　![](audio/kikitori_nb/04 トラック 4.mp3)     
海から　![](audio/kikitori_nb/06 トラック 6.mp3)     
...
段階的L1　![](audio/levelone/01 onna no ko.m4a)    
段階的L1　![](audio/levelone/02 hachi no hanashi.m4a)    
段階的L1　![](audio/levelone/03 jonsan nihon e.m4a)    
段階的L1　![](audio/levelone/04 urashima tarou.m4a)    
段階的L1　![](audio/levelone/05 warai hanashi.m4a)    
段階的L2　![](audio/levelone/Houi to chana.mp3)    
段階的L2　![](audio/levelone/Nihon no ofuro.mp3)    
段階的L4　![](audio/levelone/Toshishun.mp3)    
段階的L4　![](audio/levelone/Yuki onna.mp3)    
...
文法N3　![](audio/mimikarabunpo_n3/Track No02.mp3)   
文法N3　![](audio/mimikarabunpo_n3/Track No03.mp3)   
文法N3　![](audio/mimikarabunpo_n3/Track No04.mp3)   
文法N3　![](audio/mimikarabunpo_n3/Track No05.mp3)   
文法N3　![](audio/mimikarabunpo_n3/Track No06.mp3)   
文法N3　![](audio/mimikarabunpo_n3/Track No07.mp3)   
文法N3　![](audio/mimikarabunpo_n3/Track No08.mp3)   
文法N3　![](audio/mimikarabunpo_n3/Track No09.mp3)   
文法N3　![](audio/mimikarabunpo_n3/Track No10.mp3)   
文法N3　![](audio/mimikarabunpo_n3/Track No11.mp3)   
...
聴解N3　![](audio/mimikarachoukai_n3a/02 Track 2.mp3)   
聴解N3　![](audio/mimikarachoukai_n3a/03 Track 3.mp3)   
聴解N3　![](audio/mimikarachoukai_n3a/04 Track 4.mp3)   
聴解N3　![](audio/mimikarachoukai_n3a/05 Track 5.mp3)   
聴解N3　![](audio/mimikarachoukai_n3a/06 Track 6.mp3)   
聴解N3　![](audio/mimikarachoukai_n3a/07 Track 7.mp3)   
聴解N3　![](audio/mimikarachoukai_n3a/08 Track 8.mp3)   
聴解N3　![](audio/mimikarachoukai_n3a/09 Track 9.mp3)   
聴解N3　![](audio/mimikarachoukai_n3a/10 Track 10.mp3)   
