...
reactable(
  scknja.wa,
  columns = list(
    Words = colDef(minWidth = 22,align = "left", style = list(fontSize = 13.5, fontFamily = 'Open Sans')),
    Reading = colDef(minWidth = 25,align = "left", style = list(fontFamily = 'Open Sans')),
...
reactable(
  scrptrvw.b,
  columns = list(
    Word = colDef(align = "center", style = list(fontSize = 40, fontWeight = 600, fontFamily = 'Open Sans'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 265),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
...
reactable(
  scrptrvw.b,
  columns = list(
    Word = colDef(minWidth = 90,align = "left", style = list(fontSize = 21, fontFamily = 'Open Sans', fontWeight = 600, background = '#dee7e7'))
  ),
  defaultPageSize = 40,
  theme = reactableTheme(
    # Vertically center cells
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "simple", striped = TRUE, height = 380,
...
<!--   theme = reactableTheme( -->
<!--     # Vertically center cells -->
<!--     cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 241), -->
<!--     searchInputStyle = list( -->
<!--       paddingLeft = "8px", -->
<!--       paddingTop = "8px", -->
<!--       paddingBottom = "8px", -->
...
<!--   scrptrvw.a, -->
<!--   columns = list( -->
<!--     Word = colDef(minWidth = 90,align = "left", style = list(fontSize = 13.5, fontFamily = 'Open Sans')) -->
<!--   ), -->
<!--   defaultPageSize = 7, -->
<!--   theme = reactableTheme( -->
<!--     # Vertically center cells -->
...
<!-- spclkjn.x <- spclkjn %>% select(Words, Reading, Meaning) %>% slice(1:42) -->
<!-- spclkjn.z <- spclkjn %>% select(Words, Reading, Meaning) %>% slice(43:113) -->
<!-- spclkjn.x <- spclkjn.x[sample(1:nrow(spclkjn.x)),] -->
<!-- spclkjn.z <- spclkjn.z[sample(1:nrow(spclkjn.z)),] -->
<!-- spclkjn.a <- bind_rows(spclkjn.z, spclkjn.x) -->
<!-- # spclkjn.a <- spclkjn %>% select(Words, Reading, Meaning) %>% slice(1:56) -->
<!-- spclkjn.a <- spclkjn.a %>% na.omit(spclkjn.a) -->
<!-- # spclkjn.a <- spclkjn.a[sample(1:nrow(spclkjn.a)),] -->
...
<!--     Words = colDef( -->
<!--       cell = function(value, index) { -->
<!--         Reading <- spclkjn.a$Reading[index] -->
<!--         Reading <- if (!is.na(Reading)) Reading else "" -->
<!--         Meaning <- spclkjn.a$Meaning[index] -->
<!--         Meaning <- if (!is.na(Meaning)) Meaning else "" -->
<!--         tagList( -->
<!--           div(style = list(fontSize = 40, fontWeight = 600, fontFamily = 'Open Sans'), value), -->
<!--           div(style = list(fontSize = 10, color = '#008000'), Reading), -->
<!--           div(style = list(fontSize = 9, color = '#800000'), Meaning), -->
<!--         ) -->
<!--       }, -->
<!--       align = "center" -->
<!--     ), -->
...
<!--   spclkjn.a, -->
<!--   columns = list( -->
<!--     Words = colDef(minWidth = 40,align = "left", style = list(fontSize = 13.5, fontFamily = 'Open Sans')), -->
...
<!-- spclkjn.x <- spclkjn %>% select(Words) %>% slice(1:42) -->
<!-- spclkjn.z <- spclkjn %>% select(Words) %>% slice(43:113) -->
<!-- spclkjn.x <- spclkjn.x[sample(1:nrow(spclkjn.x)),] -->
<!-- spclkjn.z <- spclkjn.z[sample(1:nrow(spclkjn.z)),] -->
<!-- spclkjn.a <- bind_rows(spclkjn.z, spclkjn.x) -->
<!-- # spclkjn.a <- spclkjn %>% select(Words, Reading, Meaning) %>% slice(1:56) -->
...
<!--   spclkjn.a, -->
<!--   columns = list( -->
<!--     Words = colDef(minWidth = 90,align = "left", style = list(fontSize = 13.5, fontFamily = 'Open Sans')) -->
<!--   ), -->
<!--   defaultPageSize = 7, -->
<!--   theme = reactableTheme( -->
<!--     # Vertically center cells -->
...
<!-- scrptexps <- scrptexps[sample(1:nrow(scrptexps)),] -->
...
<!--       Expression = colDef( -->
<!--       cell = function(value, index) { -->
<!--         Meaning <- scrptexps$Meaning[index] -->
<!--         Meaning <- if (!is.na(Meaning)) Meaning else "" -->
<!--         tagList( -->
<!--           div(span(style = list(fontSize = 18, fontWeight = 600), value), span(style = list(fontSize = 9, color = '#008000'), " ", Meaning)) -->
<!--         ) -->
<!--       }, -->
<!--       align = "left" -->
<!--     ),     -->
<!--       Meaning = colDef(show = FALSE) -->
<!--   ), -->
<!--     outlined = TRUE, borderless = TRUE, defaultPageSize = 7, compact = FALSE, highlight = FALSE, fullWidth = TRUE, striped = FALSE, -->
<!--   showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", -->
<!--   style = list(fontFamily = "Noto Sans JP, Heiti SC, Hiragino Maru Gothic ProN, Anonymous Pro , monospace, Helvetica Neue", fontSize = "11px"), -->
<!--     theme = reactableTheme( -->
<!--     # backgroundColor = "#FF4577", -->
<!--     cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"), -->
<!--     searchInputStyle = list( -->
<!--       paddingLeft = "8px", -->
<!--       paddingTop = "8px", -->
...
reactable(
  knjsnt.la,
  columns = list(
    Sentences = colDef(minWidth = 90,align = "left", style = list(fontSize = 13.5, fontFamily = 'Open Sans', color = '#0F2040')),
    Translation = colDef(minWidth = 80,align = "left", style = list(fontSize = 10))
  ),
  defaultPageSize = 100,
  theme = reactableTheme(
    # Vertically center cells
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE, height = 491,
...
reactable(
  scknj5w.d,
  columns = list(
    W1 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, background = '#dee7e7')),
    W2 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, background = '#dee7e7')),
    W3 = colDef(align = "center", style = list(fontSize = 21, fontWeight = 600, background = '#dee7e7'))
  ),
  defaultPageSize = 5,
  theme = reactableTheme(
    # Vertically center cells
  ...
  columns = list(
    ...
    W6 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#800000'), R6),
        )
      },
      align = "center"
    ),
...
reactable(
  ...
  columns = list(
    ...
    W6 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        M6 <- scknja.xf$M6[index]
        M6 <- if (!is.na(M6)) M6 else ""
        tagList(
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 8, fontWeight = 400, color = '#266c6c'), M6),
        )
      },
      align = "center"
    ),
...
reactable(
  scknjt.wrds,
  columns = list(
    Words = colDef(align = "center", style = list(fontSize = 40, fontWeight = 600, color = '#202020', fontFamily = 'Noto Sans JP'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    # Vertically center cells
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 309),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
...
reactable(
  ...
  columns = list(
    Sentences = colDef(minWidth = 90,align = "left", style = list(fontSize = 13.5, fontFamily = 'Open Sans', color = '#0F2040')),
    # Translation = colDef(minWidth = 80,align = "left", style = list(fontSize = 11))
    Translation = colDef(show = FALSE)
  ),
  defaultPageSize = 50,
  theme = reactableTheme(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE, height = 423,
...
reactable(
  ...
  columns = list(
    Translation = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 13.5, fontWeight = 400, color = '#0F2040', fontFamily = 'Open Sans'), Sentences),
        )
      },
      align = "left"
    ),
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, paginationType = "simple", striped = TRUE, height = 484,
  ...
  columns = list(
    Sentences = colDef(
      cell = function(value, index) {
        ...
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 11, fontWeight = 400, color = '#404040'), Translation),
        )
      },
      align = "left"
    ),
...
<!--         Words <- if (!is.na(Words)) Words else "" -->
<!--         tagList( -->
<!--           div(class = "lesserh", style = list(fontSize = 30, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), Words), -->
<!--           div(class = "lesserh", style = list(fontSize = 16, fontWeight = 600, color = '#800000', fontFamily = 'Open Sans'), Reading), -->
<!--           # div(style = list(fontSize = 10, fontWeight = 500, color = '#404040'), value) -->
<!--         ) -->
<!--       }, -->
<!--       align = "center" -->
...
<!--         Meaning <- if (!is.na(Meaning)) Meaning else "" -->
<!--         tagList( -->
<!--           div(class = "lesserh", style = list(fontSize = 30, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), value), -->
<!--           div(class = "lesserh",style = list(fontSize = 12, fontWeight = 600, color = '#008000'), Meaning) -->
<!--           # div(style = list(fontSize = 11, color = '#404040'), Reading), -->
<!--         ) -->
<!--       }, -->
<!--       align = "center" -->
...
reactable(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, paginationType = "simple", striped = TRUE, height = 491,
...
adjirmbr.a <- adjirmbr  %>% slice(1:180) %>% select(Words, Expression)
...
<!--         Words <- if (!is.na(Words)) Words else "" -->
<!--         tagList( -->
<!--           div(style = list(fontSize = 35, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), Words), -->
<!--         ) -->
<!--       }, -->
<!--       align = "center" -->
<!--     ), -->
...
reactable(
  rvwadjnatb,
  columns = list(
    W1 = colDef(align = "left", html=TRUE, style = list(fontSize = 13)),
    W2 = colDef(align = "left", html=TRUE, style = list(fontSize = 13)),
    W3 = colDef(align = "left", html=TRUE, style = list(fontSize = 13)),
    W4 = colDef(align = "left", html=TRUE, style = list(fontSize = 13))
  ),
  defaultPageSize = 5,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", fontSize = "11px"),
...
vrbslstnk.0 <- vrbslstnk %>% slice(1:250)
vrbslstnk.1 <- vrbslstnk %>% slice(251:500)
vrbslstnk.2 <- vrbslstnk %>% slice(501:750)
vrbslstnk.3 <- vrbslstnk %>% slice(751:1000)
vrbslstnk.4 <- vrbslstnk %>% slice(1001:1250)
vrbslstnk.5 <- vrbslstnk %>% slice(1251:1500)
vrbslstnk.6 <- vrbslstnk %>% slice(1501:1750)
vrbslstnk.7 <- vrbslstnk %>% slice(1751:2000)
vrbslstnk.8 <- vrbslstnk %>% slice(2001:2250)
vrbslstnk.9 <- vrbslstnk %>% slice(2251:2500)
  ...
  columns = list(
    Verbs = colDef(
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(span(style = list(fontSize = 24, fontWeight = 600, fontFamily = 'Open Sans'), value), span(style = list(fontSize = 11, fontWeight = 600, fontFamily = 'Open Sans', color = '#026450'), Reading), span(style = list(fontSize = 10, fontWeight = 600, color = '#800000'), " ", Meaning))
        )
      },
      align = "left"
    ),
  ...
  columns = list(
    Verbs = colDef(
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(span(style = list(fontSize = 24, fontWeight = 600, fontFamily = 'Open Sans'), value))
        )
      },
      align = "left"
    ),
...
<!--         Meaning <- if (!is.na(Meaning)) Meaning else "" -->
<!--         tagList( -->
<!--           div(span(style = list(fontSize = 24, fontWeight = 600, fontFamily = 'Open Sans'), value), span(style = list(fontSize = 11, fontWeight = 600, fontFamily = 'Open Sans', color = '#026450'), Reading)) -->
<!--         ) -->
<!--       }, -->
<!--       align = "left" -->
<!--     ), -->
...
<!--         Meaning <- if (!is.na(Meaning)) Meaning else "" -->
<!--         tagList( -->
<!--           div(span(style = list(fontSize = 24, fontWeight = 600, fontFamily = 'Open Sans'), value), span(style = list(fontSize = 10, fontWeight = 600, color = '#800000'), Meaning)) -->
<!--         ) -->
<!--       }, -->
<!--       align = "left" -->
<!--     ), -->
...
reactable(
  ...
  columns = list(
    V1 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 9, fontWeight = 500, color = '#026450'), R1),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#800000'), M1)
        )
      },
      align = "center"
    ),
    V2 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#026450'), R2),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#800000'), M2)
        )
      },
      align = "center"
    ),    
    V3 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#026450'), R3),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#800000'), M3)
        )
      },
      align = "center"
    ), 
    V4 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#026450'), R4),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#800000'), M4)
        )
      },
      align = "center"
    ),
  ...
  defaultPageSize = 5,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 95, fontSize = "11px"),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
...
reactable(
  verbtbl.e,
  columns = list(
    V1 = colDef(align = "center", style = list(fontSize = 23, fontWeight = 600, fontFamily = 'Open Sans')),
    V2 = colDef(align = "center", style = list(fontSize = 23, fontWeight = 600, fontFamily = 'Open Sans')),
    V3 = colDef(align = "center", style = list(fontSize = 23, fontWeight = 600, fontFamily = 'Open Sans')),
    V4 = colDef(align = "center", style = list(fontSize = 23, fontWeight = 600, fontFamily = 'Open Sans'))
  ),
  defaultPageSize = 50,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 95, fontSize = "11px"),
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, paginationType = "numbers", striped = TRUE, height = 590, 
...
vrbslstnk5.a <- vrbslstnk %>% select(Verbs, Reading) %>% rename(V1 = Verbs, R1 = Reading) %>% slice(1:500)
vrbslstnk4.a <- vrbslstnk %>% select(Verbs, Reading) %>% rename(V2 = Verbs, R2 = Reading) %>% slice(501:1000)
vrbslstnk3.a <- vrbslstnk %>% select(Verbs, Reading) %>% rename(V3 = Verbs, R3 = Reading) %>% slice(1001:1500)
vrbslstnk2.a <- vrbslstnk %>% select(Verbs, Reading) %>% rename(V4 = Verbs, R4 = Reading) %>% slice(1501:2000)
vrbslstnk1.a <- vrbslstnk %>% select(Verbs, Reading) %>% rename(V5 = Verbs, R5 = Reading) %>% slice(2001:2500)
...
vrbslstnk1.a <- vrbslstnk1.a[sample(1:nrow(vrbslstnk1.a)),]

vrbslstnk.all <- data.frame(vrbslstnk5.a, vrbslstnk4.a, vrbslstnk3.a, vrbslstnk2.a, vrbslstnk1.a)
...
reactable(
  ...
  columns = list(
    ...
    V5 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        R5 <- vrbslstnk.all$R5[index]
        R5 <- if (!is.na(R5)) R5 else ""
        tagList(
          div(style = list(fontSize = 20, fontWeight = 500, fontFamily = 'Noto Sans JP'), value),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#800000'), R5),
...
vrbslstnk5.a <- vrbslstnk %>% select(Verbs, Meaning) %>% rename(V1 = Verbs, M1 = Meaning) %>% slice(1:500)
vrbslstnk4.a <- vrbslstnk %>% select(Verbs, Meaning) %>% rename(V2 = Verbs, M2 = Meaning) %>% slice(501:1000)
vrbslstnk3.a <- vrbslstnk %>% select(Verbs, Meaning) %>% rename(V3 = Verbs, M3 = Meaning) %>% slice(1001:1500)
vrbslstnk2.a <- vrbslstnk %>% select(Verbs, Meaning) %>% rename(V4 = Verbs, M4 = Meaning) %>% slice(1501:2000)
vrbslstnk1.a <- vrbslstnk %>% select(Verbs, Meaning) %>% rename(V5 = Verbs, M5 = Meaning) %>% slice(2001:2500)
  ...
  columns = list(
    Translation = colDef(
      cell = function(value, index) {
        ...
        Sentences <- if (!is.na(Sentences)) Sentences else ""
        tagList(
          div(style = list(fontSize = 13.5, fontWeight = 400, fontFamily = 'Open Sans', color = '#0F2040'), Sentences),
...
reactable(
  ...
  columns = list(
    Sentences = colDef(
      cell = function(value, index) {
        Translation <- verbrsent.freqt$Translation[index]
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          # div(style = list(fontSize = 14, fontWeight = 600), value),
          div(style = list(fontSize = 11, fontWeight = 400), Translation)
        )
      },
      align = "left"
    ),
...
reactable(
  na.omit(hnrtbl),
  columns = list(
    普通語 = colDef(align = "center", minWidth = 45, style = list(fontSize = 14, fontWeight = 500, color = '#404040', fontFamily = 'Open Sans')),
    丁寧語 = colDef(align = "center", minWidth = 60, style = list(fontSize = 14, fontWeight = 500, color = '#404040', fontFamily = 'Open Sans')),
    尊敬語 = colDef(align = "center", minWidth = 70, style = list(fontSize = 14, fontWeight = 500, color = '#404040', fontFamily = 'Open Sans')),
    謙譲語 = colDef(align = "center", minWidth = 90, style = list(fontSize = 14, fontWeight = 500, color = '#404040', fontFamily = 'Open Sans'))
  ),
  defaultPageSize = 13,
  ...
  columns = list(
    ...
    Sentences = colDef(
      ...
      cell = function(value, index) {
        ...
        T5 <- if (!is.na(T5)) T5 else ""
        tagList(
          div(style = list(fontSize = 17, fontWeight = 600, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, color = '#787878'), T1),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 17, fontWeight = 600, fontFamily = 'Open Sans'), S2),
          div(style = list(fontSize = 9, color = '#787878'), T2),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 17, fontWeight = 600, fontFamily = 'Open Sans'), S3),
          div(style = list(fontSize = 9, color = '#787878'), T3),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 17, fontWeight = 600, fontFamily = 'Open Sans'), S4),
          div(style = list(fontSize = 9, color = '#787878'), T4),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 17, fontWeight = 600, fontFamily = 'Open Sans'), S5),
          div(style = list(fontSize = 9, color = '#787878'), T5),
        )
      },
      align = "left"
...
reactable(
  ...
  onClick = "expand",
  columns = list(
    Expression = colDef(minWidth = 50, align = "left", style = list(fontSize = 15, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans')),
    Meaning = colDef(align = "left"),
    Usage = colDef(align = "left"),
    Category = colDef(minWidth = 50, align = "left"),
  ...
  details = function(index){
    ...
    tagList(
      div(class = "package-detail",
        htmltools::div(style = list(fontSize = 17, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), "・", S1),
        htmltools::div(style = list(fontSize = 17, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), "・", S2),
        htmltools::div(style = list(fontSize = 17, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), "・", S3)
      )
    )
  },
    ...
    Sentences = colDef(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 15, fontWeight = 500, color = '#404040', fontFamily = 'Open Sans'), value),
        )
      },
      align = "left"
    ),
    Remarks = colDef(align = "left")
  ),
  defaultPageSize = 8,
  theme = reactableTheme(
    # Vertically center cells
...
<!--   phrsaux, -->
<!--   columns = list( -->
<!--     Expression = colDef(align = "left", style = list(fontSize = 17, fontWeight = 400, fontFamily = 'Open Sans', color = '#0F2040')), -->
<!--     Translation = colDef(minWidth = 100, align = "left", style = list(color = '#0F2040')) -->
...
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">**Graded-Reader:**   
❊ [**TADOKU**](https://tadoku.org/japanese/free-books/)  
❊ [**YOMUJP**](https://yomujp.com)   

<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">**Travel-Sites:**   
❊ [**RETRIP**](https://retrip.jp/)    
❊ [**COTRIP**](https://co-trip.jp/)     

<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">**Japan-Places:**    
❊ [**NARA**](https://www.city.nara.lg.jp)    
❊ [**KOBE**](https://www.city.kobe.lg.jp)     
❊ [**AIZU**](https://www.aizukanko.com)     
...
reactable(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = FALSE, sortable = FALSE, paginationType = "simple", height = 600, striped = TRUE, 
...
reactable(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = FALSE, sortable = FALSE, paginationType = "numbers", height = 600, resizable = TRUE, striped = FALSE,
...
reactable(
  ...
  columns = list(
    ...
    Meaning = colDef(style= list(background = '#dee7e7'), minWidth = 100, align = "left")
...
reactable(
  ...
  columns = list(
    ...
    Translation = colDef(align = "left", style = list(color = '#0F2040', background = '#dee7e7'))
  ),
  defaultPageSize = 8,
  theme = reactableTheme(
    # Vertically center cells
