  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 10, fontWeight = 400, color = '#787878'), Translation)
        )
      },
      align = "center"
    ),
...
## Sending Parcel {.tabset}

------------------------------------------------------------------------

## Apartment Searching {.tabset}

------------------------------------------------------------------------

## Talking Experience {.tabset}

------------------------------------------------------------------------

## Habits Customs {.tabset}
