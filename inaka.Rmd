...
library(readr)
library(vembedr)
options(readr.show_col_types = FALSE, max.print=100000)
```
...
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">Cram school classroom in a self-study room.</p>
...
<p style="font-size:11px; line-height: 1; font-family: Noto Sans JP;  color: #202020;">Version 🆅.3.5</p>
...
reactable(
  scknja.wa,
  columns = list(
    Words = colDef(minWidth = 22,align = "left", style = list(fontSize = 13.5, fontFamily = 'Open Sans', background = '#dee7e7', color = '#0F2040')),
    Reading = colDef(minWidth = 25,align = "left", style = list(fontFamily = 'Open Sans', background = '#dee7e7', color = '#0F2040')),
    Meaning = colDef(minWidth = 100,align = "left", style= list(background = '#dee7e7', color = '#0F2040')) 
  ),
  defaultPageSize = 60,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE, height = 420,
...
reactable(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE, height = 515,
...
reactable(
  knjsnt.lax,
  columns = list(
    Sentences = colDef(style= list(background = '#f7f7f7'),
      cell = function(value, index) {
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE, height = 530,
  ...
  columns = list(
    Sentences = colDef(
      cell = function(value, index) {
        ...
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 16, fontWeight = 300, color = '#303030', fontFamily = 'Open Sans'), value),
          # div(style = list(fontSize = 11, fontWeight = 300, color = '#303030'), Translation)
        )
      },
      align = "left"
    ),
    Translation = colDef(align = "left", style = list(fontSize = 10, fontWeight = 300, fontFamily = 'Open Sans', color = '#303030'))
  ),
  defaultPageSize = 30,
  theme = reactableTheme(
    # Vertically center cells
    ...
    Word = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 9, fontWeight = 500, color = '#800000'), Reading),
          div(style = list(fontSize = 10, fontWeight = 500), Meaning)
        )
      },
      align = "center"
...
reactable(
  ...
  columns = list(
    ...
    W6 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
  ...
  columns = list(
    W1 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value),
          div(style = list(fontSize = 9, fontWeight = 600, fontFamily = 'Open Sans', color = '#266c6c'), M1),
        )
      },
      align = "center"
    ),
    W2 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value),
          div(style = list(fontSize = 9, fontWeight = 600, fontFamily = 'Open Sans', color = '#266c6c'), M2),
        )
      },
      align = "center"
    ),
    W3 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value),
          div(style = list(fontSize = 9, fontWeight = 600, fontFamily = 'Open Sans', color = '#266c6c'), M3),
        )
      },
      align = "center"
    ),
    W4 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value),
          div(style = list(fontSize = 9, fontWeight = 600, fontFamily = 'Open Sans', color = '#266c6c'), M4),
        )
      },
      align = "center"
    ),
    W5 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value),
          div(style = list(fontSize = 9, fontWeight = 600, fontFamily = 'Open Sans', color = '#266c6c'), M5),
        )
      },
      align = "center"
    ),
    W6 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value),
          div(style = list(fontSize = 9, fontWeight = 600, fontFamily = 'Open Sans', color = '#266c6c'), M6),
        )
      },
      align = "center"
    ),
...
scknj5.w1 <- scknj5 %>% select(W1, R1, M1) %>% rename(Words = W1, Reading = R1, Meaning = M1) %>% slice(1:40)
scknj5.w2 <- scknj5 %>% select(W2, R2, M2) %>% rename(Words = W2, Reading = R2, Meaning = M2) %>% slice(1:40)
scknj5.w3 <- scknj5 %>% select(W3, R3, M3) %>% rename(Words = W3, Reading = R3, Meaning = M3) %>% slice(1:40)
...
scknj4.w1 <- scknj4 %>% select(W1, R1, M1) %>% rename(Words = W1, Reading = R1, Meaning = M1) %>% slice(1:50)
scknj4.w2 <- scknj4 %>% select(W2, R2, M2) %>% rename(Words = W2, Reading = R2, Meaning = M2) %>% slice(1:50)
scknj4.w3 <- scknj4 %>% select(W3, R3, M3) %>% rename(Words = W3, Reading = R3, Meaning = M3) %>% slice(1:50)
...
scknj3.w1 <- scknj3 %>% select(W1, R1, M1) %>% rename(Words = W1, Reading = R1, Meaning = M1) %>% slice(1:50)
scknj3.w2 <- scknj3 %>% select(W2, R2, M2) %>% rename(Words = W2, Reading = R2, Meaning = M2) %>% slice(1:50)
scknj3.w3 <- scknj3 %>% select(W3, R3, M3) %>% rename(Words = W3, Reading = R3, Meaning = M3) %>% slice(1:50)
...
scknj2.w1 <- scknj2 %>% select(W1, R1, M1) %>% rename(Words = W1, Reading = R1, Meaning = M1) %>% slice(1:50)
scknj2.w2 <- scknj2 %>% select(W2, R2, M2) %>% rename(Words = W2, Reading = R2, Meaning = M2) %>% slice(1:50)
scknj2.w3 <- scknj2 %>% select(W3, R3, M3) %>% rename(Words = W3, Reading = R3, Meaning = M3) %>% slice(1:50)
...
scknj1.w1 <- scknj1 %>% select(W1, R1, M1) %>% rename(Words = W1, Reading = R1, Meaning = M1) %>% slice(1:50)
scknj1.w2 <- scknj1 %>% select(W2, R2, M2) %>% rename(Words = W2, Reading = R2, Meaning = M2) %>% slice(1:50)
scknj1.w3 <- scknj1 %>% select(W3, R3, M3) %>% rename(Words = W3, Reading = R3, Meaning = M3) %>% slice(1:50)
    ...
    Kanji = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 19, fontWeight = 400, color = '#202020', fontFamily = 'Open Sans'), Words),
        )
      },
      align = "center"
    ),
...
# scrptrdgn <- scrptrdgn  %>% slice(1:1)

reactable(
  scrptrdgn,
  columns = list(
    Excerpts = colDef(minWidth = 350, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans')),
    Translation = colDef(show = FALSE)
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", height = 660, resizable = TRUE, striped = TRUE,
  ...
  columns = list(
    Translation = colDef(style= list(background = '#1b1e1e'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 20, fontWeight = 500, color = '#f1f5f5', fontFamily = 'Open Sans'), Sentences),
...
reactable(
  advlmre,
  columns = list(
    Translation = colDef(style= list(background = '#f7f7f7'),
      cell = function(value, index) {
        Sentences <- advlmre$Sentences[index]
        Sentences <- if (!is.na(Sentences)) Sentences else ""
        tagList(
          div(style = list(fontSize = 20, fontWeight = 600, color = '#303030', fontFamily = 'Open Sans'), Sentences),
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, paginationType = "numbers", striped = TRUE, height = 530,
  ...
  columns = list(
    Words = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 22, fontWeight = 600, color = '#404040', fontFamily = 'Noto Sans JP'), value),
    ...
    Sentences = colDef(style= list(background = '#dee7e7'),
      ...
      cell = function(value, index) {
        ...
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 18, fontWeight = 600, color = '#404040', fontFamily = 'Noto Sans JP'), value),
  ...
  columns = list(
    Words = colDef(
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 30, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), value),
  ...
  columns = list(
    Words = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 28, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), value),
          # div(style = list(fontSize = 11, color = '#404040'), Reading),
  ...
  columns = list(
    Meaning = colDef(
      cell = function(value, index) {
        ...
        Words <- if (!is.na(Words)) Words else ""
        tagList(
          div(style = list(fontSize = 30, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), Words),
          div(style = list(fontSize = 11, color = '#404040'), Reading),
...
adjirmbr.a <- adjirmbr  %>% slice(1:252) %>% select(Words, Expression)
...
reactable(
  ...
  columns = list(
    Words = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        Expression <- adjirmbr.a$Expression[index]
        Expression <- if (!is.na(Expression)) Expression else ""
        tagList(
          div(style = list(fontSize = 28, fontWeight = 600, fontFamily = 'Open Sans'), value),
        )
...
rvwadjna.a <- rvwadjna %>% select(Expression, Meaning, Reading, Words)
  ...
  columns = list(
    Words = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 28, fontWeight = 600, color = '#404040'), value),
          # div(style = list(fontSize = 11, color = '#404040'), Reading),
          # div(style = list(fontSize = 10, color = '#404040'), Meaning)
        )
      },
...
<p style="font-size:13px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; font-weight: bold">**① Affirmative**</p>`まれに・ぜひ**`
...
adv1.a <- adv1 %>% slice(1:210) %>% rename(Sentences = S1, Translation = T1)
  ...
  columns = list(
    Meaning = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 30, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'), Word),
          div(style = list(fontSize = 11, color = '#404040'), Reading),
          div(style = list(fontSize = 10, fontWeight = 500, color = '#404040'), value)
        )
      },
...
reactable(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = FALSE, paginationType = "numbers", striped = TRUE,
...
reactable(
  vrbslstnk.all,
  columns = list(
    V1 = colDef(footer = "Total", style= list(background = '#dee7e7'),
      cell = function(value, index) {
    ...
    V4 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 10, fontWeight = 600, color = '#800000'), R4),
        )
      },
      align = "center"
    ),
  ...
  columns = list(
    V1 = colDef(footer = "Total", style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, fontWeight = 600, color = '#266c6c'), M1),
        )
      },
      align = "center"
    ),
    V2 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, fontWeight = 600, color = '#266c6c'), M2),
        )
      },
      align = "center"
    ),
    V3 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, fontWeight = 600, color = '#266c6c'), M3),
        )
      },
      align = "center"
    ),
    V4 = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 21, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, fontWeight = 600, color = '#266c6c'), M4),
        )
      },
      align = "center"
    ),
...
<div class = "col-sm-6">
    ...
    ・I think a smaller town might be better if you are going to Japan
...
<div class = "col-sm-6">
    ...
    ・My friend said he would help me
    ・Written in the newspaper that the typhoon caused a power outage
    ...
    ・According to one survey, international marriages are on the rise
...
<div class = "col-sm-6">
    ...
    ・I asked my friends if we had homework, but they didn't know also
    ・When asked what kind of Japanese food I like, An answer is at loss
...
<p style="font-size:13px; line-height: 1; font-family: Noto Sans JP;  color: #202020; font-weight: bold">**② Contrast: Connectives**</p>
...
<div class = "col-sm-6">
    ...
    ・Do you want to update the quoted prices in the calculation table?
...
<div class = "col-sm-6">    
    ...
    ・We will explain the exquisiteness and richness of the architecture.
...
reactable(
  na.omit(hnrtbl),
  columns = list(
    普通語 = colDef(align = "center", minWidth = 45, style = list(fontSize = 14, fontWeight = 500, color = '#404040', fontFamily = 'Open Sans', background = '#f7f7f7')),
    丁寧語 = colDef(align = "center", minWidth = 60, style = list(fontSize = 14, fontWeight = 500, color = '#404040', fontFamily = 'Open Sans', background = '#f7f7f7')),
    尊敬語 = colDef(align = "center", minWidth = 70, style = list(fontSize = 14, fontWeight = 500, color = '#404040', fontFamily = 'Open Sans', background = '#f7f7f7')),
    謙譲語 = colDef(align = "center", minWidth = 90, style = list(fontSize = 14, fontWeight = 500, color = '#404040', fontFamily = 'Open Sans', background = '#f7f7f7'))
  ),
  defaultPageSize = 13,
...
<p style="font-size:13px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; font-weight: bold">**② までに: End point of a quick duration or motion, By, By the time, Before, Dealine**</p>
  ...
  columns = list(
    Particles = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 22, fontWeight = 600, fontFamily = 'Open Sans'), value),
    ...
    Sentence = colDef(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 10, fontWeight = 300, color = '#303030'), Translation),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 18, fontWeight = 600), S2),
          div(style = list(fontSize = 10, fontWeight = 300, color = '#303030'), T2),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 18, fontWeight = 600), S3),
          div(style = list(fontSize = 10, fontWeight = 300, color = '#303030'), T3),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 18, fontWeight = 600), S4),
          div(style = list(fontSize = 10, fontWeight = 300, color = '#303030'), T4),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 18, fontWeight = 600), S5),
          div(style = list(fontSize = 10, fontWeight = 300, color = '#303030'), T5),
        )
      },
      align = "left"
    ),
...
<p style="font-size:13px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; font-weight: bold">**② Adjectival Clause: Complementary Clause: With toiu**</p>
...
<p style="font-size:13px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; font-weight: bold">**⑥ Adverbial Clause: Auxiliary-Adjective**</p>
...
<p style="font-size:13px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; font-weight: bold">**⑧ Conditional Clause:**</p>
  ...
  columns = list(
    Phrase = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 22, fontWeight = 600, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#303030'), Translation),
        )
      },
      align = "center"
    ),
  ...
  columns = list(
    Sentence = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 22, fontWeight = 600, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#303030'), Meaning),
        )
      },
      align = "center"
    ),
...
reactable(
  cvnptn,
  columns = list(
    Concept = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 11, fontWeight = 500, color = '#0F2040'), Meaning),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#0F2040'), Remarks),
          div(style = list(fontSize = 9, color = '#0F2040'), Info),
    ...
    Sentences = colDef(style= list(background = '#dee7e7'),
      ...
      cell = function(value, index) {
        ...
        T5 <- if (!is.na(T5)) T5 else ""
        tagList(
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#0F2040'), T1),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), S2),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#0F2040'), T2),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), S3),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#0F2040'), T3),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), S4),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#0F2040'), T4),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), S5),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#0F2040'), T5),
        )
      },
      align = "left"
    ),
  ...
  columns = list(
    Expression = colDef(style= list(background = '#dee7e7'),
      ...
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 22, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value),
          div(style = list(fontSize = 10, fontWeight = 500, color = '#0F2040'), Meaning),
        )
      },
      align = "center"
    ),
    Sentence = colDef(style= list(background = '#dee7e7'),
      minWidth = 150,
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 18, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value),
          div(style = list(fontSize = 10, color = '#0F2040'), Translation),
        )
      },
      align = "left"
    ),
...
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**1. がち　　　　　　　**・Liable to, Prone to, Tend to</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**2. っぽい　　　　　　**・Somewhat, -ish</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**3. ぎみ　　　　　　　**・Be a little, Have a touch of, -looking</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**4. きらいがある　　　**・Be liable to, Be inclined to, Have a tendency to</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**5. めく　　　　　　　**・Take on the air of, Seems, Show signs of</p>
...
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**1. がほしい　　　　　**・I want a</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**2. たい　　　　　　　**・I want to</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**3. がる　　　　　　　**・Eager to, Tends to</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**4. たらいい　　　　　**・It would be nice if</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**5. といい　　　　　　**・Hope that, Would be good if</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**6. ばいい　　　　　　**・Hope that, Would be good if</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**7. てほしい　　　　　**・Want to happen or be done</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**8. てほしいものだ　　**・Really wish</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**9. たいものだ　　　　**・I really want to</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**0. ないものか　　　　**・Isn’t there some way?</p>
...
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**1. つもりだ　　　　　**・Intends to</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**2. よう　　　　　　　**・I think I will, I'll do, Let’s do</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**3. ようとおもう　　　**・I think I will</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**4. ようとする　　　　**・Just when about to, Try to, Attempt to</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**5. ようにする　　　　**・Make a point of, Try to </p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**6. ようとしない　　　**・Doesn’t even think about, Not make an effort to</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**7. つもりだ　　　　　**・Supposed to be, But</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**8. まい　　　　　　　**・I will never, Will not, Will probably not</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**9. ようか〜まいか　　**・Whether to..or not</p>
...
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**1. になる　　　　　　**・Become</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**2. ようになる　　　　**・Become such that, Start to do </p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**3. てくる　　　　　　**・Has become, It's getting</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**4. ことがある　　　　**・There are times</p>
...
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**1. にする　　　　　　**・Will have, Decide on</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**2. ことにする　　　　**・Make up one’s mind to, I decide to </p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**3. ことになる　　　　**・Has been decide that</p>
<p style="font-size:11px; line-height: 0.5; font-family: Noto Sans JP;  color: #202020; ">**4. ことになっている　**・The case that, The custom that</p>
    ...
    Words = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 10, fontWeight = 400, color = '#0F2040'), "Level: ", Level),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 20, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans'), Sentence),
          div(style = list(fontSize = 9, fontWeight = 400, color = '#0F2040'), Translation),
        )
      },
      align = "center"
    ),
...
reactable(
  ...
  columns = list(
    ...
    Sentence = colDef(minWidth = 70, style= list(background = '#dee7e7', color = '#0F2040'),
      cell = function(value, index) {
        Translation <- gwrds.lst$Translation[index]
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 16, color = '#0F2040', fontFamily = 'Open Sans' ,fontWeight = 400), value),
  ...
  columns = list(
    Expression = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 36, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans'), value),
        )
      },
      align = "center"
    ),
...
reactable(
  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        KR <- if (!is.na(KR)) KR else ""
        tagList(
          div(style = list(fontSize = 45, fontWeight = 600, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, color = '#008000'), NR),
          div(style = list(fontSize = 9, color = '#800000'), KR),
          div(style = list(fontSize = 9, fontWeight = 500), Meaning)
        )
...
reactable(
  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        Sentences <- if (!is.na(Sentences)) Sentences else ""
        tagList(
          div(style = list(fontSize = 24, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans'), Sentences),
...
reactable(
  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        Reading <- if (!is.na(Reading)) Reading else ""
        tagList(
          div(style = list(fontSize = 30, fontWeight = 600, fontFamily = 'Open Sans'), Meaning),
          div(style = list(fontSize = 10, fontWeight = 400), Reading),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#303030'), value)
        )
      },
      align = "center"
    ),
...
reactable(
  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        Reading <- if (!is.na(Reading)) Reading else ""
        tagList(
          div(style = list(fontSize = 23, fontWeight = 600, fontFamily = 'Open Sans'), Words),
          # div(style = list(fontSize = 10, fontWeight = 400), Reading),
  ...
  columns = list(
    Script = colDef(
      ...
      cell = function(value, index) {
        ...
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 19, fontWeight = 200, color = '#101010', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
...
reactable(
  ...
  columns = list(
    Sentences = colDef(style= list(background = '#1b1e1e'),
      cell = function(value, index) {
        ...
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 18, fontWeight = 300, color = '#f1f5f5', fontFamily = 'Open Sans'), value),
  ...
  showPageInfo = FALSE, outlined = TRUE, borderless = TRUE, bordered = TRUE, searchable = TRUE, paginationType = "numbers", striped = TRUE, height = 520,
...
reactable(
  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        tagList(
          # div(style = list(fontSize = 24, fontWeight = 600), value),
          div(style = list(fontSize = 13.5, fontWeight = 400, color = '#0F2040'), Sentences),
          # div(style = list(fontSize = 8, fontWeight = 400, color = '#787878'), value)
        )
      },
      align = "left"
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE, height = 486,
...
reactable(
  shdwscrpt.a,
  columns = list(
    Script = colDef(minWidth = 140, align = "left", html = TRUE, style = list(fontSize = 15, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7')),
     Translation = colDef(minWidth = 90, align = "left", html = TRUE, style = list(fontSize = 12, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 100,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
...
reactable(
  prtcltst.a,
  columns = list(
    Particles = colDef(minWidth = 150, align = "center", html = TRUE, style = list(fontSize = 28, fontWeight = 600, color = '#0F2040', fontFamily = 'Helvetica Neue', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 300),
...
reactable(
  notesxm.a,
  columns = list(
    N3.Grammar = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "simple", height = 500, striped = TRUE, 
...
reactable(
  notesxm.a,
  columns = list(
    N2.Grammar = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
...
reactable(
  notesxm.a,
  columns = list(
    N1.Grammar = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
...
reactable(
  notesxm.a,
  columns = list(
    L2.Grammar = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
...
reactable(
  notesxm.a,
  columns = list(
    General.Concept = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
...
reactable(
  notesxm.a,
  columns = list(
    GRM.Notes = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
...
reactable(
  rdngprp,
  columns = list(
    Script = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#f1f5f5', fontFamily = 'Open Sans', background = '#1b1e1e')),
    Translation = colDef(show = FALSE)
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = FALSE, sortable = FALSE, paginationType = "simple", height = 500, striped = TRUE, 
...
reactable(
  notesxm.a,
  columns = list(
    N3.Listening = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
...
reactable(
  notesxm.a,
  columns = list(
    Notes.PowerDrill.Vocab.N3 = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
...
reactable(
  notesxm.a,
  columns = list(
    Notes.PowerDrill.Vocab.N2 = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
...
reactable(
  grmrsame.a,
  columns = list(
    Similar.Grammar.Concept = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "simple", height = 450, striped = TRUE, 
...
reactable(
  notesxm.a,
  columns = list(
    Similar.Meaning = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
...
reactable(
  notesxm.a,
  columns = list(
    Similar.Sounds = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
    ...
    Words = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 17, fontWeight = 200, fontFamily = 'Open Sans', color = '#0F2040'), Related.Words)
        )
      },
      align = "left"
    ),
...
jlptw5.a <- jlptw5 %>% slice(1:550) %>% rename(W1 = Words, R1 = Reading, M1 = Meaning)
jlptw4.a <- jlptw4 %>% slice(1:550) %>% rename(W2 = Words, R2 = Reading, M2 = Meaning)
jlptw3.a <- jlptw3 %>% slice(1:550) %>% rename(W3 = Words, R3 = Reading, M3 = Meaning)
jlptw2.a <- jlptw2 %>% slice(1:550) %>% rename(W4 = Words, R4 = Reading, M4 = Meaning)
jlptw1.a <- jlptw1 %>% slice(1:550) %>% rename(W5 = Words, R5 = Reading, M5 = Meaning)
...
jlptw5.a <- jlptw5 %>% slice(1:550) %>% select(Words) %>% rename(W5 = Words)
jlptw4.a <- jlptw4 %>% slice(1:550) %>% select(Words) %>% rename(W4 = Words)
jlptw3.a <- jlptw3 %>% slice(1:550) %>% select(Words) %>% rename(W3 = Words)
jlptw2.a <- jlptw2 %>% slice(1:550) %>% select(Words) %>% rename(W2 = Words)
jlptw1.a <- jlptw1 %>% slice(1:550) %>% select(Words) %>% rename(W1 = Words)
...
reactable(
  wrdsnt.a,
  columns = list(
    Notes = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 17, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center"),
...
reactable(
  na.omit(srsphr),
  columns = list(
    Phrase = colDef(style= list(background = '#f7f7f7'),
      minWidth =140, 
      cell = function(value, index) {
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = FALSE, sortable = FALSE, paginationType = "simple", striped = TRUE, height = 430,
...
reactable(
  ...
  columns = list(
      Expression = colDef(
       cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 28, fontWeight = 800, color = '#0F2040', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 15, fontWeight = 500, color = '#0F2040'), Expn),
          div(style = list(fontSize = 11, fontWeight = 300, color = '#0F2040'), Trans),
          div("•"),
          div(style = list(fontSize = 18, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans'), Convo1),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), T1),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans'), Convo2),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), T2),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans'), Convo3),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), T3),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans'), Convo4),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), T4),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans'), Convo5),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), T5),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans'), Convo6),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), T6),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans'), Convo7),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), T7),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans'), Convo8),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), T8),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 18, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans'), Convo9),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#800000'), T9),
        )
      },
  ...
  outlined = TRUE, defaultPageSize = 1, compact = FALSE, highlight = TRUE, fullWidth = TRUE, height = 530,
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers", striped = TRUE,
  style = list(fontFamily = "Noto Sans JP, Heiti SC, Hiragino Maru Gothic ProN, Anonymous Pro , monospace, Helvetica Neue", fontSize = "11px"),
    theme = reactableTheme(
    # Vertically center cells
