...
reactable(
  ...
  columns = list(
    ...
    丁寧語 = colDef(align = "center", minWidth = 60, style = list(fontSize = 15, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans')),
    尊敬語 = colDef(align = "center", minWidth = 70, style = list(fontSize = 15, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans')),
    謙譲語 = colDef(align = "center", minWidth = 90, style = list(fontSize = 15, fontWeight = 600, color = '#404040', fontFamily = 'Open Sans'))
