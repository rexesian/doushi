...
### CS1.0: Utilitization Elements {.tabset}
...
### CS2.0: Utilitization Patterns {.tabset}
...
### CS3.0: Utilitization Functions {.tabset}
...
### CS4.0: Utilitization Scenarios {.tabset}
...
reactable(
  ...
  onClick = "expand",
  columns = list(
    Expression = colDef(minWidth = 50, align = "left", style = list(fontSize = 15, fontWeight = 600, color = '#0F2040', fontFamily = 'Zen Kaku Gothic New', background = '#dee7e7')),
    Translation = colDef(show = FALSE)
  ),
