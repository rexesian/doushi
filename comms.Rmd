...
honlang.sonkei <- honlang %>% slice(1:10)
...
<p style="font-size:13px; line-height: 0.5; font-family: Roboto Condensed;  color: #1e3842; font-weight: bold">**Related Expressions**</p>

<p style="font-size:13px; line-height: 0.5; font-family: Roboto Condensed;  color: #1e3842; font-weight: bold">**Ⓡ youna**`Like・As`</p>

<div class = "add_infos">
Indicates a similarity or likeness between the two nouns.    
Describes how a noun is like another noun in some way.     
...
<p style="font-size:13px; line-height: 0.5; font-family: Roboto Condensed;  color: #1e3842; font-weight: bold">**Ⓡ youni naru**`Gets to a point・Reached a point where・Came to・Started to`</p>
...
・The neighbor's child has recently begun make a proper greeting.   
...
<div class = "add_infos">
Express a constant or general result that follows a certain condition.   
Express a repetitive or habitual outcome applied to a particular instance after a condition.   
Express an outcome that has come about or was triggered following a satisfied condition.   
Express an outcome that has come about which was already realized or yet to be realized.   
...
Implies inevitability or factuality.      
</div>
...
<p style="font-size:13px; line-height: 0.5; font-family: Roboto Condensed;  color: #1e3842; font-weight: bold">**<u>tameni</u>** `for・for the benefit of・in order to・due to・because of`</p>
<p style="font-size:13px; line-height: 0.5; font-family: Roboto Condensed;  color: #1e3842; font-weight: bold">**<u>youni</u>** `in order to・so that・for`</p>
<div class = "add_infos">
・<b>tameni:</b>indicate a purpose or a benefit coupled with an effort or an endeavor.    
・<b>tameni:</b>indicate a reason or a cause coupled with a result or an outcome.    
・<b>youni:</b>indicate a goal or an objective coupled with an effort or an endeavor.         
・<b>youni:</b>indicate a goal or an objective coupled with an expectation or an encouragement.        
</div>

<div class = "expresstrz">
・I am saving up to take a round-the-world trip by boat by deducting from my salary.       
・I am saving up for a round-the-world trip by boat by deducting from my salary.      
・My brother is saving up for my parents to travel around the world by paycheck deduction.       
・My brother is saving money from his salary so that my parents can travel around the world.       
・My brother has a paycheck-withdrawal savings account so that my parents can travel the world.     
</div>

<h6> </h6>

<div class = "expresstrz">
・船で世界一周旅行をするために、給料天引きの積立貯金をしている.    
・船で世界一周旅行ができるように、給料天引きの積立貯金をしている.   
・両親が世界旅行をするために、兄は給料天引きの積立貯金をしている.    
・両親が世界旅行できるように、兄は給料天引きの積立貯金をしている.    
・両親が世界旅行をするように、兄は給料天引きの積立貯金をしている.  
</div>
  ...
  columns = list(
    Words = colDef(style= list(background = '#f9f6ed'), 
      cell = function(value, index) {
        ...
        Level <- if (!is.na(Level)) Level else ""
        tagList(
          div(span(style = list(fontSize = 18, fontWeight = 600, color = '#101010', fontFamily = 'Open Sans'), value), " ", span(style = list(fontSize = 12, fontWeight = 600, color = '#800000', fontFamily = 'Open Sans'), Meaning, " ", span(style = list(fontSize = 7, fontWeight = 500, color = '#008000', fontFamily = 'Open Sans'), "L", Level))),
          div(style = list(fontSize = 10, fontWeight = 400, color = '#026450', fontFamily = 'Open Sans'), Translation),
  ...
  columns = list(
    Words = colDef(style= list(background = '#f9f6ed'), 
      cell = function(value, index) {
        ...
        Level <- if (!is.na(Level)) Level else ""
        tagList(
          div(span(style = list(fontSize = 18, fontWeight = 600, color = '#122228', fontFamily = 'Open Sans'), value), " ", span(style = list(fontSize = 12, fontWeight = 600, color = '#800000', fontFamily = 'Open Sans'), Meaning, " ", span(style = list(fontSize = 5, fontWeight = 500, color = '#008000', fontFamily = 'Open Sans'), "L", Level))),
          div(style = list(fontSize = 11, fontWeight = 600, color = '#009A77', fontFamily = 'Open Sans'), Remarks),
