...
reactable(
  ...
  columns = list(
    Verbs = colDef(style= list(background = '#1b1e1e'),
      ...
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 28, fontWeight = 500, color = '#f1f5f5', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 12, color = '#f1f5f5'), Reading),
          div(style = list(fontSize = 9.2, fontWeight = 500, color = '#f1f5f5'), Meaning),
          div(style = list(fontSize = 9, color = '#f1f5f5'), Type),
        )
      },
      align = "center"
    ),
    ...
    Sentences = colDef(style= list(background = '#1b1e1e'),
      ...
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 16, fontWeight = 500, fontFamily = 'Open Sans', color = '#f1f5f5'), value),
          div(style = list(fontSize = 9, color = '#f1f5f5'), T1),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 16, fontWeight = 500, fontFamily = 'Open Sans', color = '#f1f5f5'), S2),
          div(style = list(fontSize = 9, color = '#f1f5f5'), T2),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 16, fontWeight = 500, fontFamily = 'Open Sans', color = '#f1f5f5'), S3),
          div(style = list(fontSize = 9, color = '#f1f5f5'), T3),
        )
      },
      align = "left"
    ),
  ...
  showPageInfo = FALSE, outlined = TRUE, borderless = TRUE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers",
...
reactable(
  vnstxp,
  columns = list(
    Words = colDef(style= list(background = '#1b1e1e'),
      # Show species under character names
      cell = function(value, index) {
        ...
        Type <- if (!is.na(Type)) Type else ""
        tagList(
          div(style = list(fontSize = 28, fontWeight = 500, fontFamily = 'Open Sans', color = '#f1f5f5'), value),
          div(style = list(fontSize = 12, color = '#f1f5f5'), Reading),
          div(style = list(fontSize = 9.2, fontWeight = 500, color = '#f1f5f5'), Meaning),
          div(style = list(fontSize = 9, color = '#f1f5f5'), Type),
        )
    ...
    Sentences = colDef(style= list(background = '#1b1e1e'),
      ...
      cell = function(value, index) {
        ...
        T3 <- if (!is.na(T3)) T3 else ""
        tagList(
          div(style = list(fontSize = 14.5, fontWeight = 500, fontFamily = 'Open Sans', color = '#f1f5f5'), value),
          div(style = list(fontSize = 9, color = '#f1f5f5'), T1),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 14.5, fontWeight = 500, fontFamily = 'Open Sans', color = '#f1f5f5'), S2),
          div(style = list(fontSize = 9, color = '#f1f5f5'), T2),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 14.5, fontWeight = 500, fontFamily = 'Open Sans', color = '#f1f5f5'), S3),
          div(style = list(fontSize = 9, color = '#f1f5f5'), T3),
        )
      },
      align = "left"
  ...
  columns = list(
    ...
    Sentences = colDef(style= list(background = '#1b1e1e'),
      ...
      cell = function(value, index) {
        ...
        T3 <- if (!is.na(T3)) T3 else ""
        tagList(
          div(style = list(fontSize = 14.5, fontWeight = 500, color = '#f1f5f5', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9, color = '#f1f5f5'), T1),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 14.5, fontWeight = 500, color = '#f1f5f5', fontFamily = 'Open Sans'), S2),
          div(style = list(fontSize = 9, color = '#f1f5f5'), T2),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 14.5, fontWeight = 500, color = '#f1f5f5', fontFamily = 'Open Sans'), S3),
          div(style = list(fontSize = 9, color = '#f1f5f5'), T3),
        )
      },
      align = "left"
  ...
  columns = list(
    Words = colDef(style= list(background = '#1b1e1e'),
      ...
      cell = function(value, index) {
        ...
        Type <- if (!is.na(Type)) Type else ""
        tagList(
          div(style = list(fontSize = 24, fontWeight = 500, color = '#f1f5f5', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 10, color = '#f1f5f5'), Reading),
          div(style = list(fontSize = 11, fontWeight = 500, color = '#f1f5f5'), Meaning),
          # div(style = list(fontSize = 14), S1),
          div(style = list(fontSize = 10, color = '#f1f5f5'), K1),
          # div(style = list(fontSize = 9), S2),
          div(style = list(fontSize = 10, color = '#f1f5f5'), K2),
