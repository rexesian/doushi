...
verbrwords.freq <- lverbs %>% slice(1:234) %>% select(Verbs, Reading, Meaning, Type)
...
verbrsent.freq <- lverbs %>% slice(1:234) %>% select(S1, T1)
...
verbrwords.freqrc <- lverbs %>% slice(1:234) %>% select(Verbs, Reading, Meaning, Type)
...
verbrsent.freqrc <- lverbs %>% slice(1:234) %>% select(S1, T1)
