...
verbrwords.freq <- lverbs %>% slice(1:550) %>% select(Verbs, Reading, Meaning, Type)
...
verbrwords.a <- lverbs %>% slice(1:550) %>% select(Verbs, Reading, Meaning, Type)
...
verbrsent.a <- lverbs %>% slice(1:550) %>% select(S1, T1)
...
verbrwords.freqrc <- lverbs %>% slice(1:550) %>% select(Verbs, Reading, Meaning, Type)
...
verbrsent.freqrc <- lverbs %>% slice(1:550) %>% select(S1, T1)
