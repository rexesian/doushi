  ...
  columns = list(
    ...
    Sentences = colDef(
      ...
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 15, fontWeight = 500, fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 9), T1),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 15, fontWeight = 500, fontFamily = 'Open Sans'), S2),
          div(style = list(fontSize = 9), T2),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 15, fontWeight = 500, fontFamily = 'Open Sans'), S3),
