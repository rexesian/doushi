...
verbrwords.freq <- lverbs %>% slice(1:522) %>% select(Verbs, Reading, Meaning, Type)
...
verbrwords.a <- lverbs %>% slice(1:522) %>% select(Verbs, Reading, Meaning, Type)
...
verbrsent.a <- lverbs %>% slice(1:522) %>% select(S1, T1)
...
verbrwords.freqrc <- lverbs %>% slice(1:522) %>% select(Verbs, Reading, Meaning, Type)
...
verbrsent.freqrc <- lverbs %>% slice(1:522) %>% select(S1, T1)
