...
verbrwords.freq <- lverbs %>% slice(1:450) %>% select(Verbs, Reading, Meaning, Type)
...
verbrwords.freqrc <- lverbs %>% slice(1:450) %>% select(Verbs, Reading, Meaning, Type)
...
verbrsent.freqrc <- lverbs %>% slice(1:450) %>% select(S1, T1)
