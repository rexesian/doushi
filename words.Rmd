...
ontp <- read_csv("vrbjp/ONTPE-ONP.csv")
gwrds <- read_csv("vrbjp/WGRMR-LST.csv")
  ...
  columns = list(
    Words = colDef(
      ...
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 24, fontWeight = 600), value),
          div(style = list(fontSize = 18, fontWeight = 500, color = '#700000'), Sentences),
