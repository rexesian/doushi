    ...
    Words = colDef(style= list(background = '#e0e1dd'),
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 10, color = '#0F2040'), Reading),
    ...
    Meaning = colDef(style= list(background = '#e0e1dd'),
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 9, color = '#0F2040'), Reading),
          div(style = list(fontSize = 9, fontWeight = 500, color = '#0F2040'), value),
        )
      },
      align = "center"
    ),
