...
reactable(
  ...
  columns = list(
    ...
    Translation = colDef(minWidth = 140, align = "left", html = TRUE, style = list(fontSize = 11, fontWeight = 300, color = '#026450', fontFamily = 'Zen Kaku Gothic New', background = '#edede9', lineHeight = 2))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
