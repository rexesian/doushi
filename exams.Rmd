...
reactable(
  knjdxw,
  columns = list(
    Kanji = colDef(style= list(background = '#e0e1dd'), minWidth = 90,
      cell = function(value, index) {
    ...
    Details = colDef(html = TRUE, align = "left", minWidth = 250, style = list(fontSize = 11, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans', background = '#edede9')),
...
reactable(
  ...
  columns = list(
    ...
    Kanji = colDef(style= list(background = '#e0e1dd', minWidth = 35),
      cell = function(value, index) {
        tagList(
  ...
  defaultPageSize = 3,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", fontSize = "11px", borderColor = "#f5f5f5", height = 220),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
