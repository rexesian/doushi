...
reactable(
  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(span(style = list(color = '#e0e1dd'), "."), span(style = list(fontSize = 14, fontWeight = 300, color = '#0F2040', fontFamily = 'Helvetica Neue'), A, " ", B, " ", C, " ", D)),
        )
      },
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "numbers",
  style = list(fontFamily = "Noto Sans JP, Hiragino Maru Gothic ProN, Anonymous Pro , monospace, Helvetica Neue", fontSize = "11px", borderColor = "#e0e1dd"),
    theme = reactableTheme(
