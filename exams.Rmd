...
reactable(
  cooccurnx,
  columns = list(
    Expression = colDef(minWidth = 35, align = "left", html = TRUE, style = list(fontSize = 14, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans', background = '#e0e1dd')),
    In.Context.Meaning = colDef(minWidth = 40, align = "left", html = TRUE, style = list(fontSize = 10, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#e6e7e3')),
