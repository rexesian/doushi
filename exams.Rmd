...
div.highlight-ur { background-color: #f2f2ef; padding-left: 0px; padding-top: 7px; padding-bottom: 0.1px;
...
reactable(
  ...
  columns = list(
    ...
    Reading = colDef(minWidth = 30,align = "left", style= list(fontSize = 12, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans', background = '#e6e7e3')),
...
reactable(
  rdgsnt,
  columns = list(
    Sentences = colDef(minWidth = 300,align = "left", style = list(fontSize = 17, fontWeight = 400, color = '#0F2040', fontFamily = 'Zen Kaku Gothic New', background = '#edede9'))
  ),
  rowClass = "my-row",
  defaultPageSize = 8,
  theme = reactableTheme(
...
reactable(
  grmrsame.a,
  columns = list(
    Similar.Grammar.Concept = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 16, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#e0e1dd'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    Similar.Sounds = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 16, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#e0e1dd'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
