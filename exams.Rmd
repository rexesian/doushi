  ...
  columns = list(
    ...
    W1 = colDef(style= list(background = '#edede9'),
      cell = function(value, index) {
        ...
        R1 <- if (!is.na(R1)) R1 else ""
        tagList(
          div(style = list(fontSize = 13, fontWeight = 300, color = '#0F2040', fontFamily = 'Open Sans'), value),
          # div(style = list(fontSize = 9, fontWeight = 400, color = '#0F2040', fontFamily = 'Open Sans'), R1),
          # div(style = list(fontSize = 10, fontWeight = 400, color = '#800000', fontFamily = 'Open Sans'), M1),
        )
      },
...
reactable(
  notesxm.a,
  columns = list(
    N3.Grammar = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 12, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#e0e1dd'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    N2.Grammar = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 12, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#e0e1dd'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    N1.Grammar = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 12, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#e0e1dd'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    L2.Grammar = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 12, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#e0e1dd'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    L3.Grammar = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 12, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#e0e1dd'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    General.Concept = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 12, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#e0e1dd'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    GRM.Notes = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 12, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#e0e1dd'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
