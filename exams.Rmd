...
reactable(
  rdngprp,
  columns = list(
    Script = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 14, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#edede9', lineHeight = 2)),
    Translation = colDef(show = FALSE)
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
