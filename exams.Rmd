...
<h6> </h6>
<div class = "highlightpz">
・**② Adjectival Sentence** ・Ends with Adjectives     
...
<h6> </h6>
<div class = "highlightpz">
・**③ Verbal Sentence** ・Ends with Verbs     
・`Ends with Verbs `      
</div>
<div class = "expresstrl">
・彼らは近代の複雑な社会に**住んでいます**.    
...
・Change at the end of the sentence to **change the mode** and **to provide nuances** to the sentences.          
</div>
<div class = "expresstrl">
・きっとそれなりの理由があった**はずだ**.    
...
<h6> </h6>
<div class = "highlightpz">
・**② Clause-to-Clause Relation:** ・Not Equal         
・`相対関係：Ⓐ ≠ Ⓑ`      
</div>
<div class = "expresstrl">
・この問題は見かけほど難しくない.    
