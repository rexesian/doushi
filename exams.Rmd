...
reactable(
  na.omit(formula),
  columns = list(
    Syntax = colDef(style= list(minWidth = 2000, background = '#e0e1dd', fontSize = 11.2, fontWeight = 300, fontFamily = 'Open Sans', color = '#01161f'), html = TRUE, align = "left")),
  rowClass = "my-row",
  defaultPageSize = 10,
  theme = reactableTheme(
