...
reactable(
  dlyrdg,
  columns = list(
    Script = colDef(style= list(background = '#f9f9f7'), html = TRUE, minWidth = 200,
      cell = function(value, index) {
...
reactable(
  lstenscrpt.n3,
  columns = list(
    N3.Script = colDef(style= list(background = '#f9f9f7'), html = TRUE, minWidth = 200,
      cell = function(value, index) {
...
# <b> Memorialize </b> {.tabset}

### MZ.01: Decode-Explicit {.tabset}
