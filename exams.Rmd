...
reactable(
  rdgsnt,
  columns = list(
    Sentences = colDef(minWidth = 300,align = "left", style = list(fontSize = 15, fontWeight = 400, color = '#0F2040', fontFamily = 'Zen Kaku Gothic New', background = '#edede9'))
  ),
  rowClass = "my-row",
  defaultPageSize = 8,
  theme = reactableTheme(
...
reactable(
  ...
  columns = list(
    N3.Script = colDef(style= list(background = '#e0e1dd'), html = TRUE, minWidth = 200,
      cell = function(value, index) {
        ...
        tag_list <- tagList(
          div(class = "detail-des_func_d", HTML(lstenscrpt.n3$N3.Script[index])),
          tags$hr("aria-hidden" = "true"),
  ...
  defaultPageSize = 1,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", padding = "0px", height = 400, fontSize = "11px"),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
