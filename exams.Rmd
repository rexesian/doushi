...
reactable(
  na.omit(knjiqns),
  columns = list(
    Questions = colDef(style= list(background = '#e3e4e0', fontSize = 16, fontWeight = 300, fontFamily = 'Helvetica Neue', color = '#01161e'), html = TRUE, align = "left")),
  rowClass = "my-row",
  defaultPageSize = 7,
  theme = reactableTheme(
  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 16, fontWeight = 500, color = '#0F2040', fontFamily = 'Open Sans'), A, " ", B, " ", C, " ", D),
        )
      },
