...
dlgwrd <- dlgwrd[sample(1:nrow(na.omit(psggqns))),] 
...
reactable(
  na.omit(rgmrlpt),
  columns = list(
    Syntax = colDef(style= list(minWidth = 1900, background = '#e0e1dd', fontSize = 11.2, fontWeight = 300, fontFamily = 'Open Sans', color = '#01161f'), html = TRUE, align = "left")),
  rowClass = "my-row",
  defaultPageSize = 3,
  theme = reactableTheme(
...
reactable(
  ...
  columns = list(
    ...
    Kanji = colDef(style= list(background = '#e0e1dd', minWidth = 40),
      cell = function(value, index) {
        tagList(
    ...
    Words = colDef(style= list(minWidth = 1200, background = '#e0e1dd', fontSize = 11.2, fontWeight = 300, fontFamily = 'Open Sans', color = '#01161f'), html = TRUE, align = "left")
    ),
  rowClass = "my-row",
  defaultPageSize = 3,
  theme = reactableTheme(
