  ...
  columns = list(
    Pattern = colDef(style= list(background = '#edede9'),
      ...
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else ""
        tagList(
          div(style = list(fontSize = 12, fontWeight = 600, fontFamily = 'Righteous', color = '#026450'), value),
...
<div class = "expresstrl">
・1. <mark>音楽の先生との出会い</mark>**をきっかけに**、ピアノを習いは<mark class="green underline--red">じめました</mark>。    
