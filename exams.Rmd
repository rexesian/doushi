...
reactable(
  na.omit(formula),
  columns = list(
    Syntax = colDef(style= list(minWidth = 1800, background = '#e0e1dd', fontSize = 11.2, fontWeight = 300, fontFamily = 'Open Sans', color = '#01161f'), html = TRUE, align = "left")),
  rowClass = "my-row",
  defaultPageSize = 10,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", fontSize = "11px", borderColor = "#f5f5f5", height = 85),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
