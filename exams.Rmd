...
reactable(
  na.omit(rvwwrds),
  columns = list(
    Words = colDef(style= list(minWidth = 1500, background = '#dee7e7', fontSize = 11.2, fontWeight = 300, fontFamily = 'Open Sans', color = '#0F2040'), html = TRUE, align = "left")),
  rowClass = "my-row",
  defaultPageSize = 5,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", fontSize = "11px", borderColor = "#f5f5f5", height = 80),
...
reactable(
  na.omit(rgmrlpt),
  columns = list(
    Syntax = colDef(style= list(minWidth = 1900, background = '#dee7e7', fontSize = 11.2, fontWeight = 300, fontFamily = 'Open Sans', color = '#0F2040'), html = TRUE, align = "left")),
  rowClass = "my-row",
  defaultPageSize = 3,
  theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", fontSize = "11px", borderColor = "#f5f5f5", height = 200),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
