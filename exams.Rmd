...
reactable(
  na.omit(jtst.a),
  columns = list(
    Question = colDef(minWidth = 120, align = "left", html = TRUE, style = list(fontSize = 14, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#e0e1dd', lineHeight = 2)),
    Options = colDef(minWidth = 80, align = "left", html = TRUE, style = list(fontSize = 12, fontWeight = 200, color = '#0F2040', fontFamily = 'Open Sans', background = '#edede9', lineHeight = 2))
  ),
  rowClass = "my-row",
  defaultPageSize = 8,
  theme = reactableTheme(
