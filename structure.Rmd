...
prgrssint <- read_csv("cpdb/ADVNB-ETB.csv")
fnctionsc <- read_csv("cpdb/FNCSTC-ETB.csv")
gessence04 <- read_csv("cpdb/GRMESSP-QNS.csv")
apex <- read_csv("cpdb/ADVSYN-ETB.csv")
rvws <- read_csv("cpdb/ADVXSM-ETB.csv")
qckrmw <- read_csv("cpdb/QCKGRM-ETB.csv")
```
...
<div class = "ttlehighpss">
<div class = "ttlehigh">**③ Drive Elements・Engine** </div>  
...
・**AND-Relation**: The use **connective forms** to connect two independent clauses.           
・**AND-Relation**: The use **conjunctive particles** to connect the independent clauses.       
・**BUT-Relation**: The use **conjunctive particles** to connect two opposite independent clauses.    
・**INTER-Relation**: The use **connectives or conjunctions** to connect two independent clauses.       
</div>
<h6> </h6>
...
・**Relative Clause**: Using a **relative clause** as a subordinate clause to provide additional information.           
・**Complement Clause**: Using a **complement clause** as a subordinate clause to complete the meaning of whole sentence.       
・**Conditional Clause**: Using a **conditional clause** as a subordinate clause to set some conditions.    
</div>
<h6> </h6>
...
<p style="font-size:13px; line-height: 1; font-family: Roboto Condensed;  color: #1e3842; font-weight: bold">**① Past: -ta indicates past actions, events, and states**</p>
...
<p style="font-size:13px; line-height: 1; font-family: Roboto Condensed;  color: #1e3842; font-weight: bold">**① Non-Past: -ru・u presents habitual actions and events or future actions and events**</p>
...
<p style="font-size:13px; line-height: 1; font-family: Roboto Condensed;  color: #1e3842; font-weight: bold">**① Request: Asking with te moraemasu・moraemasen ka**</p>
...
<p style="font-size:13px; line-height: 1; font-family: Roboto Condensed;  color: #1e3842; font-weight: bold">**② Request: Asking with te kuremasen ka**</p>
...
<p style="font-size:13px; line-height: 1; font-family: Roboto Condensed;  color: #1e3842; font-weight: bold">**③ Request: Asking with onegai**</p>
...
reactable(
  setwrdcmb,
  columns = list(
    Words = colDef(style= list(background = '#e0e1dd'), minWidth = 120, 
      cell = function(value, index) {
    ...
    Meaning = colDef(minWidth = 170, align = "left", style = list(fontSize = 12, fontWeight = 600, color = '#0F2040', fontFamily = 'Zen Kaku Gothic New', background = '#edede9')),
...
reactable(
  vnst.all,
  columns = list(
    Sentence = colDef(style= list(background = '#e0e1dd'),minWidth = 900, 
      cell = function(value, index) {
...
reactable(
  sntcas.all,
  columns = list(
    Sentences = colDef(style= list(background = '#e0e1dd'),minWidth = 900, 
      cell = function(value, index) {
...
reactable(
  dlyexps.a,
  columns = list(
    Expression = colDef(style= list(background = '#e0e1dd'),minWidth = 900, 
      cell = function(value, index) {
...
reactable(
  icwrds,
  columns = list(
    Script = colDef(style= list(background = '#e0e1dd'),minWidth = 900, 
      cell = function(value, index) {
...
reactable(
  vnstg,
  columns = list(
    Phrases = colDef(style= list(background = '#e0e1dd'),minWidth = 900, 
      cell = function(value, index) {
...
reactable(
  vnstb,
  columns = list(
    Phrase = colDef(style= list(background = '#e0e1dd'),minWidth = 900, 
      cell = function(value, index) {
...
### ES:01 Schema.Foundation {.tabset}
...
reactable(
  apex,
  columns = list(
    Expression = colDef(minWidth = 80,align = "left", html = TRUE, sticky = "left", style = list(background = '#edede9', fontSize = 12, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040')),
    Meaning = colDef(minWidth = 200,align = "left", html = TRUE, style = list(background = '#e3e4e0', fontSize = 10.5, fontWeight = 400, fontFamily = 'Open Sans', color = '#0F2040')),
    Sample = colDef(minWidth = 350,align = "left", html = TRUE, style = list(background = '#e0e1dd', fontSize = 12.5, fontWeight = 500, fontFamily = 'Zen Kaku Gothic New', color = '#0F2040'))
  ),
  rowClass = "my-row",
  defaultPageSize = 5,
  theme = reactableTheme(
  ...
  showPageInfo = FALSE, outlined = TRUE, borderless = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, resizable = TRUE, wrap = TRUE, paginationType = "numbers", highlight = TRUE,
...
reactable(
  rvws,
  columns = list(
    Content = colDef(minWidth = 300,align = "left", html = TRUE, sticky = "left", style = list(background = '#edede9', fontSize = 11.5, fontWeight = 400, fontFamily = 'Open Sans', color = '#0F2040')),
    # Description = colDef(minWidth = 200,align = "left", html = TRUE, style = list(background = '#e3e4e0', fontSize = 10.5, fontWeight = 400, fontFamily = 'Open Sans', color = '#0F2040')),
    Description = colDef(minWidth = 350,align = "left", html = TRUE, style = list(background = '#e0e1dd', fontSize = 10.5, fontWeight = 400, fontFamily = 'Zen Kaku Gothic New', color = '#0F2040'))
  ),
  rowClass = "my-row",
  defaultPageSize = 18,
  theme = reactableTheme(
  ...
  showPageInfo = FALSE, outlined = TRUE, borderless = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, resizable = TRUE, wrap = FALSE, paginationType = "numbers", highlight = TRUE,
...
reactable(
  ...
  columns = list(
    # Content = colDef(minWidth = 300,align = "left", html = TRUE, sticky = "left", style = list(background = '#edede9', fontSize = 11.5, fontWeight = 400, fontFamily = 'Open Sans', color = '#0F2040')),
    # Description = colDef(minWidth = 350,align = "left", html = TRUE, style = list(background = '#e0e1dd', fontSize = 10.5, fontWeight = 400, fontFamily = 'Zen Kaku Gothic New', color = '#0F2040')),
    Content = colDef(style= list(background = '#edede9'), minWidth = 140,
      cell = function(value, index) {
        Interpretation <- qckrmw$Interpretation[index]
        Interpretation <- if (!is.na(Interpretation)) Interpretation else ""
        tagList(
          div(style = list(fontSize = 15, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 10, fontWeight = 300, color = '#026450', fontFamily = 'Zen Kaku Gothic New'), Interpretation),
        )
      },
      align = "left"
    ), 
    Meaning = colDef(style= list(background = '#e3e4e0'), minWidth = 260,
      cell = function(value, index) {
        Description <- qckrmw$Description[index]
        Description <- if (!is.na(Description)) Description else ""
        tagList(
          div(style = list(fontSize = 11, fontWeight = 700, color = '#510304', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 10, fontWeight = 300, color = '#01161e', fontFamily = 'Zen Kaku Gothic New'), Description),
        )
      },
      align = "left"
    ), 
    Example = colDef(style= list(background = '#e0e1dd'), minWidth = 280,
      cell = function(value, index) {
        Translation <- qckrmw$Translation[index]
        Translation <- if (!is.na(Translation)) Translation else ""
        tagList(
          div(style = list(fontSize = 13, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 10, fontWeight = 300, color = '#02474A', fontFamily = 'Zen Kaku Gothic New'), Translation),
        )
      },
      align = "left"
    ),
    Interpretation = colDef(show = FALSE),
...
### ES:02 Schema.References {.tabset}
...
reactable(
  na.omit(gessence0x),
  columns = list(
    Expression = colDef(minWidth = 60,align = "left", html = TRUE, style = list(background = '#dee7e7', fontSize = 11.2, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040')),
    ...
    Meaning = colDef(style= list(background = '#dee7e7'), minWidth = 110, sticky = "left",
      cell = function(value, index) {
        Usage <- gessence0x$Usage[index]
        Usage <- if (!is.na(Usage)) Usage else ""
        tagList(
          div(style = list(fontSize = 10.5, fontWeight = 600, color = '#0F2040', fontFamily = 'Open Sans'), value),
          div(style = list(fontSize = 10.5, fontWeight = 300, color = '#0F2040', fontFamily = 'Open Sans'), Usage),
        )
      },
      align = "left"
    ),
    ...
    Example = colDef(minWidth = 140, align = "left", html = TRUE, style = list(background = '#dee7e7', fontSize = 10.5, fontWeight = 300, fontFamily = 'Open Sans', color = '#0F2040')),
...
# gessence01 <- gessence01[sample(1:nrow(na.omit(gessence01))),]
# gessence01 <- gessence01[sample(1:nrow(gessence01)),]
gessence0x <- gessence01 %>% slice(41:60)

reactable(
  na.omit(gessence0x),
  columns = list(
    Expression = colDef(minWidth = 70,align = "left", html = TRUE, style = list(background = '#dee7e7', fontSize = 11.2, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040')),
    # Meaning = colDef(minWidth = 60,align = "left", html = TRUE, style = list(background = '#dee7e7', fontSize = 10.5, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040')),
    Meaning = colDef(style= list(background = '#dee7e7'), minWidth = 130, sticky = "left",
      cell = function(value, index) {
        Usage <- gessence0x$Usage[index]
        Usage <- if (!is.na(Usage)) Usage else ""
        tagList(
...
# fnctionsc <- fnctionsc[sample(1:nrow(na.omit(fnctionsc))),]
# fnctionsc <- fnctionsc[sample(1:nrow(fnctionsc)),]
fnctionsc.a <- fnctionsc %>% slice(1:20)
...
# fnctionsc <- fnctionsc[sample(1:nrow(na.omit(fnctionsc))),]
# fnctionsc <- fnctionsc[sample(1:nrow(fnctionsc)),]
fnctionsc.a <- fnctionsc %>% slice(21:40)
...
reactable(
  advusg.a,
  columns = list(
    Notes = colDef(minWidth = 600, align = "left", html = TRUE, style = list(fontSize = 11.2, fontWeight = 300, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  # rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    N3.Grammar = colDef(minWidth = 1200, align = "left", html = TRUE, style = list(fontSize = 11.2, fontWeight = 300, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    N2.Grammar = colDef(minWidth = 1200, align = "left", html = TRUE, style = list(fontSize = 11.2, fontWeight = 300, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    N1.Grammar = colDef(minWidth = 1200, align = "left", html = TRUE, style = list(fontSize = 11.2, fontWeight = 300, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    L3.Grammar = colDef(minWidth = 1200, align = "left", html = TRUE, style = list(fontSize = 11.2, fontWeight = 300, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    L2.Grammar = colDef(minWidth = 1200, align = "left", html = TRUE, style = list(fontSize = 11.2, fontWeight = 300, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
# gessence04 <- gessence04[sample(1:nrow(na.omit(gessence04))),]
# gessence04 <- gessence04[sample(1:nrow(gessence04)),]
...
### ES:04 Schema.Boosting {.tabset}

```{r, echo=FALSE, message=FALSE}

# prgrssint <- prgrssint[sample(1:nrow(na.omit(prgrssint))),]
# prgrssint <- prgrssint[sample(1:nrow(prgrssint)),]
# prgrssint <- prgrssint %>% slice(1:20)
...
reactable(
  notesxm.a,
  columns = list(
    GRM.Notes = colDef(minWidth = 800, align = "left", html = TRUE, style = list(fontSize = 11.2, fontWeight = 300, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
