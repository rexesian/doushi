...
reactable(
  rvws,
  columns = list(
    Content = colDef(minWidth = 300,align = "left", html = TRUE, sticky = "left", style = list(background = '#edede9', fontSize = 12, fontWeight = 400, fontFamily = 'Open Sans', color = '#0F2040')),
