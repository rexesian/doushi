...
<!-- verbrws <- verbrw %>% select(Sentences) -->
<!-- verbrws <- verbrws[sample(1:nrow(verbrws)),] -->

<!-- reactable( -->
<!--   na.omit(verbrws), -->
<!--   columns = list( -->
<!--     Sentences = colDef(align = "center", style = list(fontSize = 32, fontWeight = 600)) -->
<!--   ), -->
<!--   defaultPageSize = 1, -->
<!--   theme = reactableTheme( -->
<!--     # Vertically center cells -->
...
<!-- Knjwrdss4 <- scknj5 %>% select(W1, W2, W3) -->
<!-- Knjwrdss4 <- Knjwrdss4 %>% pivot_longer(everything()) -->
<!-- Knjwrdss4 <- Knjwrdss4 %>% rename(W1 = value) -->
<!-- Knjwrdss4 <- na.omit(Knjwrdss4) %>% select(W1) -->
<!-- Knjwrdss4 <- Knjwrdss4[sample(1:nrow(Knjwrdss4)),] -->

<!-- reactable( -->
<!--   na.omit(Knjwrdss4), -->
<!--   columns = list( -->
<!--     W1 = colDef(align = "center", style = list(fontSize = 32, fontWeight = 600)) -->
<!--   ), -->
<!--   defaultPageSize = 1, -->
<!--   theme = reactableTheme( -->
<!--     # Vertically center cells -->
...
<!-- Knjwrdss4 <- scknj4 %>% select(W1, W2, W3) -->
<!-- Knjwrdss4 <- Knjwrdss4 %>% pivot_longer(everything()) -->
<!-- Knjwrdss4 <- Knjwrdss4 %>% rename(W1 = value) -->
<!-- Knjwrdss4 <- na.omit(Knjwrdss4) %>% select(W1) -->
<!-- Knjwrdss4 <- Knjwrdss4[sample(1:nrow(Knjwrdss4)),] -->
...
<!-- Knjwrdss4 <- scknj3 %>% select(W1, W2, W3) -->
<!-- Knjwrdss4 <- Knjwrdss4 %>% pivot_longer(everything()) -->
<!-- Knjwrdss4 <- Knjwrdss4 %>% rename(W1 = value) -->
<!-- Knjwrdss4 <- na.omit(Knjwrdss4) %>% select(W1) -->
<!-- Knjwrdss4 <- Knjwrdss4[sample(1:nrow(Knjwrdss4)),] -->
...
<!-- Knjwrdss4 <- scknj2 %>% select(W1, W2, W3) -->
<!-- Knjwrdss4 <- Knjwrdss4 %>% pivot_longer(everything()) -->
<!-- Knjwrdss4 <- Knjwrdss4 %>% rename(W1 = value) -->
<!-- Knjwrdss4 <- na.omit(Knjwrdss4) %>% select(W1) -->
<!-- Knjwrdss4 <- Knjwrdss4[sample(1:nrow(Knjwrdss4)),] -->
...
<!-- Knjwrdss4 <- scknj1 %>% select(W1, W2, W3) -->
<!-- Knjwrdss4 <- Knjwrdss4 %>% pivot_longer(everything()) -->
<!-- Knjwrdss4 <- Knjwrdss4 %>% rename(W1 = value) -->
<!-- Knjwrdss4 <- na.omit(Knjwrdss4) %>% select(W1) -->
<!-- Knjwrdss4 <- Knjwrdss4[sample(1:nrow(Knjwrdss4)),] -->
...
<!-- Knjwrdlst4 <- knjlst1 %>% select(Words, w2, w3, w4, w5, w6, w7, w8) -->
<!-- Knjwrdlst4 <- Knjwrdlst4 %>% pivot_longer(everything()) -->
<!-- Knjwrdlst4 <- Knjwrdlst4 %>% rename(Word = value) -->
<!-- Knjwrdlst4 <- na.omit(Knjwrdlst4) %>% select(Word) -->
<!-- Knjwrdlst4 <- Knjwrdlst4[sample(1:nrow(Knjwrdlst4)),] -->

<!-- reactable( -->
<!--   na.omit(Knjwrdlst4), -->
<!--   columns = list( -->
<!--     Word = colDef(align = "center", style = list(fontSize = 32, fontWeight = 600)) -->
<!--   ), -->
<!--   defaultPageSize = 1, -->
<!--   theme = reactableTheme( -->
<!--     # Vertically center cells -->
...
<!-- Knjwrdlst4 <- knjlst2 %>% select(Words, w2, w3, w4, w5, w6, w7, w8) -->
<!-- Knjwrdlst4 <- Knjwrdlst4 %>% pivot_longer(everything()) -->
<!-- Knjwrdlst4 <- Knjwrdlst4 %>% rename(Word = value) -->
<!-- Knjwrdlst4 <- na.omit(Knjwrdlst4) %>% select(Word) -->
<!-- Knjwrdlst4 <- Knjwrdlst4[sample(1:nrow(Knjwrdlst4)),] -->
...
<!-- Knjwrdlst4 <- knjlst3 %>% select(Words, w2, w3, w4, w5, w6, w7, w8) -->
<!-- Knjwrdlst4 <- Knjwrdlst4 %>% pivot_longer(everything()) -->
<!-- Knjwrdlst4 <- Knjwrdlst4 %>% rename(Word = value) -->
<!-- Knjwrdlst4 <- na.omit(Knjwrdlst4) %>% select(Word) -->
<!-- Knjwrdlst4 <- Knjwrdlst4[sample(1:nrow(Knjwrdlst4)),] -->
...
<!-- Knjwrdlst4 <- knjlst4 %>% select(Words, w2, w3, w4, w5, w6, w7, w8) -->
<!-- Knjwrdlst4 <- Knjwrdlst4 %>% pivot_longer(everything()) -->
<!-- Knjwrdlst4 <- Knjwrdlst4 %>% rename(Word = value) -->
<!-- Knjwrdlst4 <- na.omit(Knjwrdlst4) %>% select(Word) -->
<!-- Knjwrdlst4 <- Knjwrdlst4[sample(1:nrow(Knjwrdlst4)),] -->
...
<!-- Knjwrdlst4 <- knjlst5 %>% select(Words, w2, w3, w4, w5, w6, w7, w8) -->
<!-- Knjwrdlst4 <- Knjwrdlst4 %>% pivot_longer(everything()) -->
<!-- Knjwrdlst4 <- Knjwrdlst4 %>% rename(Word = value) -->
<!-- Knjwrdlst4 <- na.omit(Knjwrdlst4) %>% select(Word) -->
<!-- Knjwrdlst4 <- Knjwrdlst4[sample(1:nrow(Knjwrdlst4)),] -->
...
<!-- Knjwrdmst4 <- knjlstr %>% select(w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, w19, w20, w21, w22, w23, w24, w25, w26, w27) -->
<!-- Knjwrdmst4 <- Knjwrdmst4 %>% pivot_longer(everything()) -->
<!-- Knjwrdmst4 <- Knjwrdmst4 %>% rename(Word = value) -->
<!-- Knjwrdmst4 <- na.omit(Knjwrdmst4) %>% select(Word) -->
<!-- Knjwrdmst4 <- Knjwrdmst4[sample(1:nrow(Knjwrdmst4)),] -->
...
<!-- # mwrdslvl <- mwrdslvl %>% slice(2723:4861) -->
<!-- mwrdslvl <- mwrdslvl[sample(1:nrow(mwrdslvl)),] -->
...
<!--     Expression = colDef( -->
<!--       cell = function(value, index) { -->
<!--         Reading <- mwrdslvl$Reading[index] -->
<!--         Reading <- if (!is.na(Reading)) Reading else "" -->
<!--         Meaning <- mwrdslvl$Meaning[index] -->
<!--         Meaning <- if (!is.na(Meaning)) Meaning else "" -->
<!--         tagList( -->
    ...
    Concept = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 10, fontWeight = 400), Remarks),
          # div(style = list(fontSize = 9), S.Remarks),
          # div(style = list(fontSize = 10, fontWeight = 500), Structure),
        )
      },
      align = "center"
    ),
    Sentences = colDef(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 9), T4),
          div(style = list(fontSize = 2), " "),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 1), "."),
          div(style = list(fontSize = 17, fontWeight = 500), S5),
          div(style = list(fontSize = 9), T5),
        )
      },
      align = "left"
    ),
