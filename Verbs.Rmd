...
<p style="font-size:12px;">(❖) **Godan Verb (Noun Stem)**</p>
...
<p style="font-size:12px;">(❖) **Ichidan Verb (Noun Stem)**</p>

    ・食べる　⇢   食べ
    ・見る　　⇢   見

<p style="font-size:12px;">(❖) **Irregular Verb (Noun Stem)**</p>
...
<p style="font-size:12px;">(❖) **Godan Verb (Command Stem)**</p>
...
<p style="font-size:12px;">(❖) **Ichidan Verb (Command Stem)**</p>
...
<p style="font-size:12px;">**⚭　Vte + kuru ** `started to・(I'm/It's) getting`</p>
