...
**⑤　Existential Sentence** `Verb aru・iru as the engine`
...
**③　Relative Clauses with Compound Particles (Pre-Nominal Form)**

###### **⚭　Clause + Compound Particle + Noun**
...
**⑧　Clauses before Compound Particles (Pre-Verbal Form)**

###### **⚭　Clause + ni tsurete・etc**
...
<pre>
<code style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color: #202020">⓵＿＿週まつは　としょかんに行ったり　えいがかんで　えいがを見たり　します。⓶＿＿はれているしゅうまつは　こうえんで　あそんだり　山に　のぼったり します。今週まつは　はれますから　ともだちと　いっしょに　⓷ ＿＿。たぶん、グルフのれんしゅうも　します。</code>
</pre>
...
reactable(
  skmscn,
  columns = list(
    Basis = colDef(align = "left"),
    Skimming = colDef(minWidth = 250,align = "left"),
    Scanning = colDef(minWidth = 250,align = "left")
...
```
[**keydifferences.com**](https://keydifferences.com/difference-between-skimming-and-scanning.html)
