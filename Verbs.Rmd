...
<pre>
<code style="font-size:20px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color: #202020">⓵＿＿週まつは　としょかんに行ったり　えいがかんで　えいがを見たり　します。⓶＿＿はれているしゅうまつは　こうえんで　あそんだり　山に　のぼったり します。今週まつは　はれますから　ともだちと　いっしょに　⓷ ＿＿。たぶん、グルフのれんしゅうも　します。</code>
</pre>
...
<pre>
<code style="font-size:20px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color: #202020">レストラン　ブラグを　書いています⓵＿＿　しゅうまつ　いつも　いろいろな　レストランで　食べます。新しいレストランで　りょうりを食べながら　ノートを　取ります。それから、いえにかえって　ブラグを　書きます。ぎおんの　新しい　フランスりょうりのレストラン　行きます。</code>
</pre>
...
<pre>
<code style="font-size:20px; line-height: 1.4; font-family:  Noto Sans JP; font-weight: 300; color: #202020">来週の日よう日は、スキーの りょこうに 行きます。あさの 8 時に 出て よるの 8 時に かえります。お金が 8,000 円 かかります。
...
<pre>
<code style="font-size:20px; line-height: 1.4; font-family:  Noto Sans JP; font-weight: 300; color: #202020">兄は 来月 45 さいに なります。わかいとき からだが　よわくて あまり はたらきませんでした。しかし、今は 毎日 あさに はしります。それから、8 時から よるの 8時まではたらきます。</code>
</pre>
...
<pre>
<code style="font-size:20px; line-height: 1.4; font-family:  Noto Sans JP; font-weight: 300; color: #202020">わたしは　あきこさん　10年ぐらい　しっています。がっこうで、　はじめて　あってから　どこでも　いっしょに　行きました。わたしは　あるいて　５分ぐらいの　ところに　すんでいたので、　わたしは　いつも　あきこさんのいえに行きました。毎週まつ　そこで　かわいい　ふくをきて　うたをうたいました。わたしたちは　ゆうめいになりたかったです。
...
<pre>
<code style="font-size:20px; line-height: 1.4; font-family:  Noto Sans JP; font-weight: 300; color: #202020">この地方のスキー場はコース大部分は整備されており、滑りにくいうことはあまりありません。⓵＿＿、風が強く、⓶＿＿降った雪も積もるか積もらないかのうちに飛ばされてしまうことが多いのです。</code>
</pre>
