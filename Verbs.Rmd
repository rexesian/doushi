...
###### **M describes the action/state of E**
...
reactable(
  na.omit(exwrds),
  columns = list(
    Connectives = colDef(align = "center", style = list(fontSize = 34, fontWeight = 600))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    # Vertically center cells
...
reactable(
  na.omit(exwrds),
  columns = list(
    Adverbials = colDef(align = "center", style = list(fontSize = 34, fontWeight = 600))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    # Vertically center cells
...
reactable(
  na.omit(exwrds),
  columns = list(
    Na.Adjectives = colDef(align = "center", style = list(fontSize = 34, fontWeight = 600))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    # Vertically center cells
...
reactable(
  na.omit(exwrds),
  columns = list(
    I.Adjectives = colDef(align = "center", style = list(fontSize = 34, fontWeight = 600))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    # Vertically center cells
...
reactable(
  na.omit(exwrds),
  columns = list(
    Onomatope = colDef(align = "center", style = list(fontSize = 34, fontWeight = 600))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    # Vertically center cells
...
reactable(
  na.omit(exwrds),
  columns = list(
    Interrogatives = colDef(align = "center", style = list(fontSize = 34, fontWeight = 600))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    # Vertically center cells
  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 2), "."),
          div(style = list(fontSize = 14, fontWeight = 200), A, " ", B, " ", C, " ", D),
        )
      },
...
### Scanning.Skimming {.tabset}

**Scanning**  

```{r, echo=FALSE, message=FALSE}

memb <- mem %>% slice(141:144)
...
###### **Adverbial Clause + no + Noun**

<span style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color:#800000">熱帯魚を買うときは目や体を見れば健康な</span>
<span style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color:#202020">**魚**</span>
<span style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color:#00435b">がわかる</span>

<span style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color:#800000">ガーデニングで丹精した我が家の庭の</span>
<span style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color:#202020">**我**</span>
<span style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color:#800000">が家の庭の</span>
<span style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color:#202020">**花**</span>
<span style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color:#00435b">写すなら</span>

<span style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color:#800000">自分でオーディオシステムを組む</span>
<span style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color:#202020">**人**</span>
<span style="font-size:18px; line-height: 1.4; font-family: Noto Sans JP; font-weight: 300; color:#00435b">が多い</span>
...
```{=html}
<p style="font-size:15px; line-height: 0.5; font-family: Noto Sans JP; font-weight: 300; color: #202020; font-weight: bold">プレゼンテーションの基礎</p>  
<p  style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">1. プレゼンテーションとは何か
<br>2. プレゼンテーションの構成要素
</p>
<br>
<p style="font-size:15px; line-height: 0.5; font-family: Noto Sans JP; font-weight: 300; color: #202020; font-weight: bold">プレゼンテーションとは何か</p> 
<p style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">
...
<br>
<p style="font-size:15px; line-height: 0.5; font-family: Noto Sans JP; font-weight: 300; color: #202020; font-weight: bold">プレゼンテーションの構成要素</p> 
<p style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">
プレゼンテーションは、図１のように、いろいろな要素から成り立っています。上手なプレゼンテーションをする場合には、これらの要素すべてについて、練習や準備をする必要があります。
</p>
<br>
<p style="font-size:15px; line-height: 0.5; font-family: Noto Sans JP; font-weight: 300; color: #202020; font-weight: bold">プレゼンテーション</p>  
<p  style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">1. プレゼンテーションの内容
<br>2. プレゼンテーションの方法
</p>
<pre>
<code  style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">必要な表現・伝える内容</code>
</pre>
<pre>
<code  style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">見せ方（スライド・ハンドアウトなど）<br>話し方や態度（声の大きいさ・話す速さ・発音・態度など）</code>
</pre>
```
...
```{=html}
<p style="font-size:15px; line-height: 0.5; font-family: Noto Sans JP; font-weight: 300; color: #202020; font-weight: bold">プレゼンテーションの流れと表現</p>  
<p  style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">1. プレゼンテーションの流れ
<br>2. 関連の表現
</p>
<br>
<p style="font-size:15px; line-height: 0.5; font-family: Noto Sans JP; font-weight: 300; color: #202020; font-weight: bold">プレゼンテーションの流れ</p> 
<p style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">
自分の調べたこと、研究したことあるいは主張したいことを聞いている人にわかりやすく発表するためには、内容の構成や順序をわかりやすくする必要があります。一般的に大学レベルでプレゼンテーションをする時の構成は、次の湯になります。
</p>
<pre>
<code  style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">イントロダクション　➔　本文　➔　結論・まとめ　➔　質疑応答</code>
</pre>
<br>
<p style="font-size:15px; line-height: 0.5; font-family: Noto Sans JP; font-weight: 300; color: #202020; font-weight: bold">関連の表現：イントロダクション</p> 
<p style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">
イントロダクション：これから発表することについて簡単に説明する。
</p>
<pre>
<code style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">・これから〜について話します。
...
<pre>
<code style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">・私がこのテーマを選んだ理由は、〜からです。
・この研究の目的は、〜ということです。</code>
</pre>
<br>
<p style="font-size:15px; line-height: 0.5; font-family: Noto Sans JP; font-weight: 300; color: #202020; font-weight: bold">関連の表現：本文</p> 
<p style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">
本文：調査・研究の方法、結果、考察について説明する。
</p>
<pre>
<code style="font-size:15px; line-height: 1.6; font-family: Noto Sans JP; font-weight: 300; color: #202020">・まず、調査の方法について説明します。
