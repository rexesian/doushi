      ...
      Expression = colDef(
       cell = function(value, index) {
        ...
        tagList(
          ...
          div("•"),
          div(style = list(fontSize = 16, fontWeight = 500), Convo1),
          div(style = list(fontSize = 10, fontWeight = 500), T1),
          div(style = list(fontSize = 16, fontWeight = 500), Convo2),
          div(style = list(fontSize = 10, fontWeight = 500), T2),
          div(style = list(fontSize = 16, fontWeight = 500), Convo3),
          div(style = list(fontSize = 10, fontWeight = 500), T3),
          div(style = list(fontSize = 16, fontWeight = 500), Convo4),
          div(style = list(fontSize = 10, fontWeight = 500), T4),
          div(style = list(fontSize = 16, fontWeight = 500), Convo5),
          div(style = list(fontSize = 10, fontWeight = 500), T5),
          div(style = list(fontSize = 16, fontWeight = 500), Convo6),
          div(style = list(fontSize = 10, fontWeight = 500), T6),
          div(style = list(fontSize = 16, fontWeight = 500), Convo7),
          div(style = list(fontSize = 10, fontWeight = 500), T7),
          div(style = list(fontSize = 16, fontWeight = 500), Convo8),
          div(style = list(fontSize = 10, fontWeight = 500), T8),
          div(style = list(fontSize = 16, fontWeight = 500), Convo9),
