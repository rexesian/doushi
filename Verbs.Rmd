...
**あえて** `dare to・daringly・deliberately・purposely` **⚭　aete + action**  
...
**あくまでも** `to the end・to the last・persistency` **⚭　akumademo + N/V**  
...
**あるいは** `or・possibly` **⚭　aruiwa + N/Phrase**  
...
**ぶりに** `for the first time in (time period)` **⚭　N (time period) + burini**  
