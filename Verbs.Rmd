...
reactable(
  vrbrvws,
  columns = list(
    W1 = colDef(minWidth = 140, style = list(fontSize = 25, fontWeight = 600), align = "center"), 
    W2 = colDef(minWidth = 140, style = list(fontSize = 25, fontWeight = 600), align = "center"), 
    W3 = colDef(minWidth = 140, style = list(fontSize = 25, fontWeight = 600), align = "center")

  ),
  defaultPageSize = 3,fullWidth = FALSE,
  theme = reactableTheme(
    # Vertically center cells
  ...
  style = list(fontFamily = "Klee One, Noto Sans JP, Hiragino Maru Gothic ProN, Anonymous Pro , monospace, Helvetica Neue", fontSize = "11px")
)
