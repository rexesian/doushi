...
verbrw <- verbrw %>% select(Words)
verbrw <- verbrw[sample(1:nrow(verbrw)),]

reactable(
  verbrw,
  columns = list(
    Words = colDef(align = "center", style = list(fontSize = 34, fontWeight = 600))
  ),
  defaultPageSize = 1,
  theme = reactableTheme(
    # Vertically center cells
...
<!--   vrbrvws, -->
<!--   columns = list( -->
<!--     W1 = colDef(minWidth = 120, style = list(fontSize = 23, fontWeight = 500), align = "center"),  -->
<!--     W2 = colDef(minWidth = 120, style = list(fontSize = 23, fontWeight = 500), align = "center"),  -->
<!--     W3 = colDef(minWidth = 120, style = list(fontSize = 23, fontWeight = 500), align = "center"), -->
<!--     W4 = colDef(minWidth = 120, style = list(fontSize = 23, fontWeight = 500), align = "center"), -->
<!--     W5 = colDef(minWidth = 120, style = list(fontSize = 23, fontWeight = 500), align = "center"), -->
<!--     W6 = colDef(minWidth = 120, style = list(fontSize = 23, fontWeight = 500), align = "center") -->
...
reactable(
  ...
  showPageInfo = FALSE, bordered = TRUE, searchable = TRUE, sortable = FALSE, paginationType = "jump",
