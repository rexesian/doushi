...
reactable(
    ...
    Kanji = colDef(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 14, fontWeight = 600), M1),
          div(style = list(fontSize = 9), N1),
          div(style = list(fontSize = 14, fontWeight = 600), M2),
          div(style = list(fontSize = 9), N2),
          div(style = list(fontSize = 14, fontWeight = 600), M3),
          div(style = list(fontSize = 9), N3),
          div(style = list(fontSize = 14, fontWeight = 600), M4),
          div(style = list(fontSize = 9), N4),
          div(style = list(fontSize = 14, fontWeight = 600), M5),
          div(style = list(fontSize = 9), N5),
          div(style = list(fontSize = 14, fontWeight = 600), M6),
          div(style = list(fontSize = 9), N6),
          div(style = list(fontSize = 14, fontWeight = 600), M7),
          div(style = list(fontSize = 9), N7),
          div(style = list(fontSize = 14, fontWeight = 600), M8),
          div(style = list(fontSize = 9), N8),
          div(style = list(fontSize = 14, fontWeight = 600), M9),
          div(style = list(fontSize = 9), N9),
          div(style = list(fontSize = 14, fontWeight = 600), M10),
          div(style = list(fontSize = 9), N10),
          div(style = list(fontSize = 14, fontWeight = 600), M11),
          div(style = list(fontSize = 9), N11),
          div(style = list(fontSize = 14, fontWeight = 600), M12),
  ...
  theme = reactableTheme(
    # Vertically center cells
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 470),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
