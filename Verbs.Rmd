...
reactable(
    ...
    Verbs = colDef(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 9.2), Meaning),
  ...
  theme = reactableTheme(
    # Vertically center cells
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 105),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
