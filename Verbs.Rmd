...
<p></p>
<pre align="center">
<code> しかも。それも。さらに。そのうえ。それに。また。それから。そして。でも。しかし。けれども。または。それとも。あるいは。それで。すると。
だから。そこで。したがって。そのけっか。そのために。ところで。なぜなら。たとえば。つまり。ようするに。ちなみに。</code>
</pre>
...
正式。正常。大切。大変。直接。独自。非常。不安。不足。不満。不明。普通。豊か。本当。名誉。</code>
</pre>
...
<p></p>
<pre align="center">
<code> 私。僕。俺。あなた。君。彼。彼女。私達。僕達。俺達。彼ら。我々。</code>
</pre>
