...
usge <- read_csv("vrbjp/USGE-USGE.csv")
```
  ...
  columns = list(
    ...
    K6 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 25, fontWeight = 600), value),
          div(style = list(fontSize = 9, fontWeight = 500), M6),
        )
      },
      align = "center"
    ),       
    K7 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 25, fontWeight = 600), value),
          div(style = list(fontSize = 9, fontWeight = 500), M7),
        )
      },
      align = "center"
    ),
    K8 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 25, fontWeight = 600), value),
          div(style = list(fontSize = 9, fontWeight = 500), M8),
        )
      },
      align = "center"
    ),    
    ...
    K6 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 14, fontWeight = 500), W6),
        )
      },
      align = "center"
    ),       
    K7 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 14, fontWeight = 500), W7),
        )
      },
      align = "center"
    ),
    K8 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 14, fontWeight = 500), W8),
        )
      },
      align = "center"
    ),    
...
# usge <- usge[sample(1:nrow(usge)),]

# usge <- usge %>% slice(1:25)
    ...
    K1 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 25, fontWeight = 600), value),
          div(style = list(fontSize = 9, fontWeight = 500), M1),
          div(style = list(fontSize = 9, fontWeight = 500), N1),
          div(style = list(fontSize = 13, fontWeight = 500), W1),
        )
      },
      align = "center"
    ...
    K2 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 25, fontWeight = 600), value),
          div(style = list(fontSize = 9, fontWeight = 500), M2),
          div(style = list(fontSize = 9, fontWeight = 500), N2),
          div(style = list(fontSize = 13, fontWeight = 500), W2),
        )
      },
      align = "center"
    ...
    K3 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 25, fontWeight = 600), value),
          div(style = list(fontSize = 9, fontWeight = 500), M3),
          div(style = list(fontSize = 9, fontWeight = 500), N3),
          div(style = list(fontSize = 13, fontWeight = 500), W3),
        )
      },
      align = "center"
    ...
    K4 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 25, fontWeight = 600), value),
          div(style = list(fontSize = 9, fontWeight = 500), M4),
          div(style = list(fontSize = 9, fontWeight = 500), N4),
          div(style = list(fontSize = 13, fontWeight = 500), W4),
        )
      },
      align = "center"
    ...
    K5 = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 25, fontWeight = 600), value),
          div(style = list(fontSize = 9, fontWeight = 500), M5),
          div(style = list(fontSize = 9, fontWeight = 500), N5),
          div(style = list(fontSize = 13, fontWeight = 500), W5),
        )
      },
      align = "center"
...
<!--   cmnknj, -->
<!--   columns = list( -->
<!--     W1 = colDef(minWidth = 83, style = list(fontSize = 13, fontWeight = 600), align = "center"),  -->
<!--     W2 = colDef(minWidth = 83, style = list(fontSize = 13, fontWeight = 600), align = "center"),  -->
<!--     W3 = colDef(minWidth = 83, style = list(fontSize = 13, fontWeight = 600), align = "center"),  -->
<!--     W4 = colDef(minWidth = 83, style = list(fontSize = 13, fontWeight = 600), align = "center"),  -->
<!--     W5 = colDef(minWidth = 83, style = list(fontSize = 13, fontWeight = 600), align = "center"),  -->
<!--     W6 = colDef(minWidth = 83, style = list(fontSize = 13, fontWeight = 600), align = "center"),  -->
<!--     W7 = colDef(minWidth = 83, style = list(fontSize = 13, fontWeight = 600), align = "center"),  -->
...
<!-- <h> -->
    ...
    ・あの国は政治が安定していないので、生活水準は低いままだ。
    ・体の大小を問わず、動物は安全な場所で眠る。
