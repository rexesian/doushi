  ...
  columns = list(
    Sentences = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 24, fontWeight = 600), value),
          div(style = list(fontSize = 9, color = '#787878'), Sayachi.Translation)
        )
      },
      align = "center"
    ),
  ...
  columns = list(
    Sentences = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 24, fontWeight = 600), value),
          div(style = list(fontSize = 9, color = '#787878'), Kakochin.Translation)
        )
      },
      align = "center"
    ),
  ...
  columns = list(
    Sentences = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 24, fontWeight = 600), value),
          div(style = list(fontSize = 9, color = '#787878'), Ikechan.Translation)
        )
      },
      align = "center"
    ),
...
smplsnt <- smplsnt[sample(1:nrow(smplsnt)),]
...
reactable(
  ...
  columns = list(
    Sentences = colDef(
      cell = function(value, index) {
        Translation <- smplsnt$Translation[index]
        Translation <- if (!is.na(Translation)) Translation else "Unknown"
        tagList(
          div(style = list(fontSize = 24, fontWeight = 600), value),
          div(style = list(fontSize = 9, color = '#787878'), Translation)
  ...
  columns = list(
    Sentences = colDef(
      cell = function(value, index) {
        ...
        tagList(
          # div(style = list(fontSize = 24, fontWeight = 600), value),
          div(style = list(fontSize = 12, fontWeight = 600), Sayachi.Translation)
        )
      },
      align = "center"
    ),
