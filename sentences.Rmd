...
#           div(style = list(fontSize = 10, color = '#787878'), Translation)
#         )
#       },
#       align = "center"
#     ),
...
reactable(
  vnstc,
  columns = list(
    Sentence = colDef(style= list(background = '#1b1e1e'),
      cell = function(value, index) {
        Translation <- vnstc$Translation[index]
...
# sntdly <- sntdly[sample(1:nrow(sntdly)),]
# sntdly <- bind_rows(sntdly, comdly)
# sntdly <- sntdly[sample(1:nrow(sntdly)),]
...
#         tagList(
#           div(style = list(fontSize = 24, fontWeight = 600, fontFamily = 'Open Sans'), value),
#           div(style = list(fontSize = 10, color = '#787878'), Meaning)
#         )
#       },
#       align = "center"
#     ),
...
reactable(
  ...
  columns = list(
    ...
    Meaning = colDef(align = "left", style = list(fontSize = 10, fontWeight = 300, fontFamily = 'Open Sans', background = '#1b1e1e', color = '#f1f5f5'))
    ...
    Translation = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          # div(style = list(fontSize = 13, fontWeight = 600), Concept),
