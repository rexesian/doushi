...
reactable(
  vnst.all,
  columns = list(
    Sentence = colDef(style= list(background = '#1b1e1e'), minWidth = 580,
...
reactable(
  vnsgg,
  columns = list(
    Sentences = colDef(style= list(background = '#1b1e1e'), minWidth = 580,
      cell = function(value, index) {
...
reactable(
  icwrds,
  columns = list(
    Script = colDef(style= list(background = '#1b1e1e'), minWidth = 580,
      cell = function(value, index) {
...
reactable(
  expw,
  columns = list(
    Expression = colDef(style= list(background = '#1b1e1e'), minWidth = 580,
      cell = function(value, index) {
...
reactable(
  vnstg,
  columns = list(
    Phrases = colDef(style= list(background = '#1b1e1e'), minWidth = 580,
      cell = function(value, index) {
...
reactable(
  vnstb,
  columns = list(
    Phrase = colDef(style= list(background = '#1b1e1e'), minWidth = 580,
      cell = function(value, index) {
    ...
    Sentence = colDef(style= list(background = '#dee7e7'),
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 25, fontWeight = 600, fontFamily = 'Open Sans', color = '#0F2040'), value)
        )
      },
      align = "center"
    ),
...
reactable(
  rrdng,
  columns = list(
    Article = colDef(style= list(background = '#1b1e1e'),
      minWidth = 280,
      cell = function(value, index) {
