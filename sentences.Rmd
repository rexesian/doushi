...
reactable(
  notesxm.a,
  columns = list(
    N3.Grammar = colDef(minWidth = 600, align = "left", html = TRUE, style = list(fontSize = 11.2, fontWeight = 300, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
...
reactable(
  notesxm.a,
  columns = list(
    L3.Grammar = colDef(minWidth = 150, align = "left", html = TRUE, style = list(fontSize = 11.2, fontWeight = 300, color = '#0F2040', fontFamily = 'Open Sans', background = '#dee7e7'))
  ),
  rowClass = "my-row",
  defaultPageSize = 1,
  theme = reactableTheme(
